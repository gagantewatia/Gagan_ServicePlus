package SPPrintingandStationeryDepartmentHaryana;
...
import Pageobject.SPPrintingandStationeryDepartmentHaryana.PrintingandStationeryDepartmentHaryana;
import Resources.Base2;

public class ChangeofNameTestCases extends Base2
{
	...
	{
		test.assignCategory(PrintingandStationeryDepartmentHaryana);
...
//go to department page	
...

	{
		test.assignCategory(PrintingandStationeryDepartmentHaryana);
		 departmentnavigationpage SD=new departmentnavigationpage(Driver);
		 String Servicename="Printing and Stationery Department Haryana";
	 	 SD.servicenavigationclick(Servicename);
		 Assert.assertEquals(SD.PrintingandStationeryDepartmentHaryana().getText(),"Printing and Stationery Department Haryana","Not matched");
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				PrintingandStationeryDepartmentHaryana dp=new PrintingandStationeryDepartmentHaryana(Driver); 
				dp.infoName().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Change of Name","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Change of Name"));

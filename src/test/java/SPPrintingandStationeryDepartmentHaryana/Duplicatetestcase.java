	...
	//go to department page	
		...
		
		{
			...
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Printing and Stationery Department Haryana");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Printing and Stationery Department Haryana :  " + cl.duplicateTestCases());
		     }
		}
...

			{
				...
				commonlocators cl=new commonlocators(Driver);
			String x="Printing and Stationery Department Haryana";

...
public class MukhyaMantriSamajikSurakshaYojnaforregisteredworkerofHBOCWWBoardTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoMukhyaMantriSamajik().click();
				test.log(Status.INFO,"Clicked on i icon"); 
				Assert.assertEquals(PQ.infoservicename2().getText(),"Mukhya Mantri Samajik Suraksha Yojna for registered worker of HBOCWW Board","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Mukhya Mantri Samajik Suraksha Yojna for registered worker of HBOCWW Board"));

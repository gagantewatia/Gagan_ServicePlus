...
public class MukhyaMantriMahilaNirmanShramikSammaanYojnaforregisteredWomenworkersofHBOCWWBoardTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoMukhyaMantriMahila().click();
				test.log(Status.INFO,"Clicked on i icon"); 
				Assert.assertEquals(PQ.infoservicename2().getText(),"Mukhya Mantri Mahila Nirman Shramik Sammaan Yojna for registered Women workers of HBOCWW Board","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Mukhya Mantri Mahila Nirman Shramik Sammaan Yojna for registered Women workers of HBOCWW Board"));

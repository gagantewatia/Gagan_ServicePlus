...
public class MedicalAssistanceWageCompensationduringillnessforregisteredworkerofHBOCWWBoardTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoMedicalAssistance().click();
				test.log(Status.INFO,"Clicked on i icon"); 
				Assert.assertEquals(PQ.infoservicename2().getText(),"Medical Assistance / Wage Compensation during illness for registered worker of HBOCWW Board","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Medical Assistance / Wage Compensation during illness for registered worker of HBOCWW Board"));

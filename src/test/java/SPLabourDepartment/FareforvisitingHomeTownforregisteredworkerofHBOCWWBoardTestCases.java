...
public class FareforvisitingHomeTownforregisteredworkerofHBOCWWBoardTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoFarEvisitingHome().click();
				test.log(Status.INFO,"Clicked on i icon"); 
				Assert.assertEquals(PQ.infoservicename2().getText(),"Fare for visiting Home Town for registered worker of HBOCWW Board","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Fare for visiting Home Town for registered worker of HBOCWW Board"));

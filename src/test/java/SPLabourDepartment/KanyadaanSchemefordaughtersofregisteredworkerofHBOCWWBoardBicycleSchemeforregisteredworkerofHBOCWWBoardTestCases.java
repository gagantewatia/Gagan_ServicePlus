...
public class KanyadaanSchemefordaughtersofregisteredworkerofHBOCWWBoardBicycleSchemeforregisteredworkerofHBOCWWBoardTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoKanyadaanScheme().click();
				test.log(Status.INFO,"Clicked on i icon"); 
				Assert.assertEquals(PQ.infoservicename2().getText(),"Kanyadaan Scheme for daughters of registered worker of HBOCWW Board","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Kanyadaan Scheme for daughters of registered worker of HBOCWW Board"));

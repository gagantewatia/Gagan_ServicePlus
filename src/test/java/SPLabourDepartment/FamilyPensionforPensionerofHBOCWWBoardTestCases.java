...
public class FamilyPensionforPensionerofHBOCWWBoardTestCases extends Base2
{
...
//go to department page	
	...
	public void DeptNavigation() throws IOException, InterruptedException
	{
		test.assignCategory(LabourDepartment);
		 ...
		 Assert.assertEquals(SD.LabourDepartment().getText(), "Labour Department Haryanat","Not matched");
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoFamilyPension().click();
				test.log(Status.INFO,"Clicked on i icon"); 
				Assert.assertEquals(PQ.infoservicename2().getText(),"Family Pension for Pensioner of HBOCWW Board","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Family Pension for Pensioner of HBOCWW Board"));

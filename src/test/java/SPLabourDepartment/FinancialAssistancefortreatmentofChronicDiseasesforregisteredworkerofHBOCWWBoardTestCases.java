...
public class FinancialAssistancefortreatmentofChronicDiseasesforregisteredworkerofHBOCWWBoardTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				Assert.assertEquals(PQ.infoservicename2().getText(),"Financial Assistance for treatment of Chronic Diseases for registered worker of HBOCWW Board","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Financial Assistance for treatment of Chronic Diseases for registered worker of HBOCWW Board"));

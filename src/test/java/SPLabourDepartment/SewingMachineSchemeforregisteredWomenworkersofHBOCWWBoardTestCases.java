...
public class SewingMachineSchemeforregisteredWomenworkersofHBOCWWBoardTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoSewingMachineScheme().click();
				test.log(Status.INFO,"Clicked on i icon"); 
				Assert.assertEquals(PQ.infoservicename2().getText(),"Sewing Machine Scheme for registered Women workers of HBOCWW Board","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Sewing Machine Scheme for registered Women workers of HBOCWW Board"));

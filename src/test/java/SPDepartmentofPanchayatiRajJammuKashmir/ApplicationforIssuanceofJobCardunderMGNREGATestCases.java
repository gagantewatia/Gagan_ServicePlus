...
import Pageobject.SPDepartmentofPanchayatiRajJammuKashmir.DepartmentofPanchayatiRajJammuKashmir;
import Resources.Base2;

public class ApplicationforIssuanceofJobCardunderMGNREGATestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				Assert.assertEquals(PQ.infoservicename().getText(),"Application for Issuance of Job Card under MGNREGA","Not matched");
				PQ.desccheck();
	...
	{
	test.assignCategory(DepartmentofPanchayatiRajJammuKashmir);
	DepartmentofPanchayatiRajJammuKashmir dp=new DepartmentofPanchayatiRajJammuKashmir(Driver);
	...
	Assert.assertTrue(s.contains("Application for Issuance of Job Card under MGNREGA"));

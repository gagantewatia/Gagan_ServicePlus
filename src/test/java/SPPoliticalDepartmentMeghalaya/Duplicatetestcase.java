	...
	//go to department page	
		...
		
		{
			...
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Political Department Meghalaya");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Political Department Meghalaya " + cl.duplicateTestCases());
		     }
		}
		...
		{
			commonlocators cl=new commonlocators(Driver);
		String x="Political Department Meghalaya";

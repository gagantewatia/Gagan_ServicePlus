	...
	//go to department page	
		...
		public void Deptnavigation() throws IOException, InterruptedException
		{
			test.assignCategory(PublicWorksDepartment);
			 ...
			 Assert.assertEquals(SD.PublicWorksDepartment().getText(),"Public Works Department (RandB)","Not matched"); Assert.assertTrue(SD.DeptTagline().getText().contains("Service Plus Services")); 
		...
		
		{
			...
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Public Works Department (RandB).");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Public Works Department (RandB) " + cl.duplicateTestCases());
		     }
		}
...

		{
			test.assignCategory(PublicWorksDepartment);
			commonlocators cl=new commonlocators(Driver);
		String x="Public Works Department (RandB)";

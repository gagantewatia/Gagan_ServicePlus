...
public class RegistrationofContractorsClassVforWorksandServicesEoDBTestCases extends Base2
{
...
//go to department page	
	...
	//go to service and check heading
...

		{
				...
				dp.infoClassVforWorksand().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Registration of Contractors Class V for Works and Services - EoDB","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Registration of Contractors Class V for Works and Services - EoDB"));

package SPDeptOfAnimalHusbandry;
...
import Pageobject.SPDepOfAnimalHusbandry.DepOfAnimalHusbandry;
import Resources.Base2;

public class  TrainingofPartTimeVolunteerforArtificialInseminationandCastrationwithStipendwithoutstipendTestCase extends Base2
{
...
//go to department page	
...

	{
		test.assignCategory(DepOfAnimalHusbandry);
		 departmentnavigationpage SD=new departmentnavigationpage(Driver);
		 String Servicename="Department of Animal Husbandry and Veterinary Services Andaman & Nicobar Island";
	 	 SD.servicenavigationclick(Servicename);
		 Assert.assertEquals(SD.DepOfAnimalHusbandry().getText(),"Department of Animal Husbandry and Veterinary Services Andaman & Nicobar Island","Not matched");
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				DepOfAnimalHusbandry dp=new DepOfAnimalHusbandry(Driver);
				  dp.infoArtificialInsemination().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Training of Part Time Volunteer for Artificial Insemination and Castration with Stipend/without stipend","Not matched");
				PQ.desccheck();
	...
	dp.ArtificialInsemination().click();
	Thread.sleep(2000);
	List<String> browserTabs = new ArrayList<String> (Driver.getWindowHandles());
	//switch to new tab
	...
	Assert.assertTrue(s.contains("Training of Part Time Volunteer for Artificial Insemination and Castration with Stipend/without stipend"));

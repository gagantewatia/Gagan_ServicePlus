...
public class ProvidingonemonthTrainingonDairyFarmingwithStipendWithoutStipendTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoDairyFarming().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Providing one month Training on Dairy Farming with Stipend/Without Stipend","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Providing one month Training on Dairy Farming with Stipend/Without Stipend"));

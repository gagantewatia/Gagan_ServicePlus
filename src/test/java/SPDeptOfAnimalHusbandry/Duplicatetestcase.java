	...
	//go to department page	
		...
		
		{
			...
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Department of Animal Husbandry and Veterinary Services");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Department of Animal Husbandry and Veterinary Services :  " + cl.duplicateTestCases());
		     }
		}
		//check servcie count
...

				{
					test.assignCategory(DepOfAnimalHusbandry);
					commonlocators cl=new commonlocators(Driver);
				String x="Department of Animal Husbandry and Veterinary Services Andaman & Nicobar Island";

...
public class ImpartingonemonthtrainingonPoultryPiggeryGoatFarmingwithStipendwithoutStipendTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoOneMonthTraining().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Imparting one month training on Poultry, Piggery, Goat Farming with Stipend/ without Stipend","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Imparting one month training on Poultry, Piggery, Goat Farming with Stipend/ without Stipend"));

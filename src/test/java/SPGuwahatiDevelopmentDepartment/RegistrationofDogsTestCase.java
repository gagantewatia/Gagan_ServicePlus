...
public class RegistrationofDogsTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				Assert.assertEquals(PQ.infoservicename2().getText(),"Registration of Dogs","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Registration of Dogs"));

...
public class TradeLicenserelatedtoVeterinaryTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoTradeLicense().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Trade License related to Veterinary","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Renewal of trade license related to veterinary"));

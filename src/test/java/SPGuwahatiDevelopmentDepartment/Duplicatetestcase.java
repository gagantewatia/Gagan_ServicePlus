	...
	//go to department page	
		...
		
		{
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Guwahati Development Department");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Guwahati Development Department :  " + cl.duplicateTestCases());
		     }
		}

	...
	//go to department page	
		...
		
		{
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Health Department (GMSH)");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Health Department (GMSH) :  " + cl.duplicateTestCases());
		     }
		}
...

		{
			test.assignCategory(HealthDepartment);
			commonlocators cl=new commonlocators(Driver);
		String x="Health Department (GMSH)";

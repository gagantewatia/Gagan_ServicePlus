...
public class JananiSurakshaYojnaTestCase extends Base2
{
...
//go to department page	
	...
	//go to service and check heading
...

		{
				...
				dp.infoJananiSuraksha().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Janani Suraksha Yojna","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Janani Suraksha Yojna"));

...
public class RenewalofArmsLicenseTestCase extends Base2
{
...
//go to department page	
...

		{
				...
				Infopage PQ=new Infopage(Driver);
				 DepartmenOfHome dp=new DepartmenOfHome(Driver);
					dp.infoRenewalofArms().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Renewal of Arms License","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Renewal of Arms License"));

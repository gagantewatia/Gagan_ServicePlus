...
public class IssuanceofDuplicateArmLicenseTestCase extends Base2
{
...
//go to department page	
...

		{
				...
				Infopage PQ=new Infopage(Driver);
				 DepartmenOfHome dp=new DepartmenOfHome(Driver);
					dp.infoDuplicateArmLicense().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Issuance of Duplicate Arm License","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Issuance of Duplicate Arm License"));

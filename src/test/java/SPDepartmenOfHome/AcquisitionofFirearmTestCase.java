...
public class AcquisitionofFirearmTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoAcquisitionFirearm().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Acquisition of Firearm","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Acquisition of Firearm"));

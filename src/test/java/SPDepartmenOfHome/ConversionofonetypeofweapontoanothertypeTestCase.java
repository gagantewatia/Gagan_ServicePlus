...
public class ConversionofonetypeofweapontoanothertypeTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoConversion().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Conversion of one type of weapon to another type","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Conversion of one type of weapon to another type"));

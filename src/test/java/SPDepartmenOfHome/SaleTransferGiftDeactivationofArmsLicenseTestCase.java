...
public class SaleTransferGiftDeactivationofArmsLicenseTestCase extends Base2
{
...
//go to department page	
...

		{
				...
				Infopage PQ=new Infopage(Driver);
				 DepartmenOfHome dp=new DepartmenOfHome(Driver);
					dp.infoGiftofArms().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Sale/Transfer/Gift/Deactivation of Arms License","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Sale/Transfer/Gift/Deactivation of Arms License"));

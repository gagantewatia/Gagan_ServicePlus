...
public class EndorsementofWeaponinArmsLicenseTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoEndorsementofWeapon().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Endorsement of Weapon in Arms License","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Endorsement of Weapon in Arms License"));

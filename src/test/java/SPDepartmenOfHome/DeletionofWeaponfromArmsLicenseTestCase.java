...
public class DeletionofWeaponfromArmsLicenseTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoDeletionWeapon().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Deletion of Weapon from Arms License","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Deletion of Weapon from Arms License"));

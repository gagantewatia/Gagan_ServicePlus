...
public class ExtensionofAreaValidityofArmsLicenseTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoValidityofArms().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Extension of Area Validity of Arms License","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Extension of Area Validity of Arms License"));

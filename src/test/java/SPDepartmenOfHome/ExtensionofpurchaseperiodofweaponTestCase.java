...
public class ExtensionofpurchaseperiodofweaponTestCase extends Base2
{
...
//go to department page	
...

		{
				...
				Infopage PQ=new Infopage(Driver);
				 DepartmenOfHome dp=new DepartmenOfHome(Driver);
					dp.infoExtension().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Extension of purchase period of weapon","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Extension of purchase period of weapon"));

...
public class CasteCertificateforEBCIandBCIINonCreamyLayerTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoEBCINonCreamyLayer().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Caste Certificate for EBC I and BC II (Non Creamy Layer)","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Caste Certificate for EBC I and BC II"));

...
public class CasteCertificateforEBCIandBCIIfortheareanotcoveredunderULBorRLBTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoCasteCertificate().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Caste Certificate for EBC I and BC II for the area not covered under ULB or RLB","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Caste Certificate for EBC I and BC II for the area not covered under ULB or RLB"));

...
public class CasteCertificateforSCWhereLocalInspectionReportIsRequiredTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoLocalInspection().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Caste Certificate for SC Where Local Inspection Report Is Required","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Caste Certificate for SC Where Local Inspection Report Is Required"));

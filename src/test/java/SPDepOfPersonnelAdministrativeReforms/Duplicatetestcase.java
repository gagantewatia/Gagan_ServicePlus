	...
	//go to department page	
		...
		
		{
			...
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Department of Personnel, Administrative Reforms and Raj Bhasa");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Department of Personnel, Administrative Reforms and Raj Bhasa :  " + cl.duplicateTestCases());
		     }
		}
		...
		//check servcie count
...

				{
					test.assignCategory(DepOfPersonnelAdministrativeReforms);
					commonlocators cl=new commonlocators(Driver);
				String x="Department of Personnel, Administrative Reforms and Raj Bhasa";

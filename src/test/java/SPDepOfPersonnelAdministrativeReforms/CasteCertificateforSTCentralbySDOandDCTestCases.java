...
public class CasteCertificateforSTCentralbySDOandDCTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoSTCentral().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Caste Certificate for ST Central by SDO and DC","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Caste Certificate for ST Central by SDO and DC"));

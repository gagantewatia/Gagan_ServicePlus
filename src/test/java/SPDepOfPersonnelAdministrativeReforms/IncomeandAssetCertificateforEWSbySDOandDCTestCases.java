...
public class IncomeandAssetCertificateforEWSbySDOandDCTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoAssetCertificateSDO().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Income and Asset Certificate for EWS by SDO and DC","Not matched");
				PQ.desccheck();
	...
	@Test(priority=36,dependsOnMethods = {"DeptNavigation"})
	...
	Assert.assertTrue(s.contains("Income and Asset Certificate for EWS by SDO and DC"));

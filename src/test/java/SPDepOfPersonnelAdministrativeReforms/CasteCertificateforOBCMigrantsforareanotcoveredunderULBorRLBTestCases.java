...
public class CasteCertificateforOBCMigrantsforareanotcoveredunderULBorRLBTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoULBorRLB().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Caste Certificate for OBC Migrants for area not covered under ULB or RLB","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Caste Certificate for OBC-Migrants for area not covered under ULB or RLB"));

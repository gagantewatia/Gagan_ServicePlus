...
public class LocalResidentCertificatebyCircleOfficerTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				PQ.seeinfo2iconflat().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename().getText(),"Local Resident Certificate by Circle Officer","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Local Resident Certificate by Circle Officer"));

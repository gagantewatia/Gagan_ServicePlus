...
public class IncomeandAssetCertificateforEWSbySDOandDCfortheareanotcoveredunderULBorRLBTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				Assert.assertEquals(PQ.infoservicename2().getText(),"Income and Asset Certificate for EWS by SDO and DC for the area not covered under ULB or RLB","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Income and Asset Certificate for EWS by SDO and DC for the area not covered under ULB or RLB"));

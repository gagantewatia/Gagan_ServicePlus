...
public class IncomeandAssetCertificateforEWSTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoCircleOfficer().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Income and Asset Certificate for EWS","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Income and Asset Certificate for EWS"));

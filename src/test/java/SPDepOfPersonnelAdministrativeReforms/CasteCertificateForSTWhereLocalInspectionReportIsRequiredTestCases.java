...
public class CasteCertificateForSTWhereLocalInspectionReportIsRequiredTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoSTLocalInspection().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Caste Certificate For ST Where Local Inspection Report Is Required","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Caste Certificate For ST Where Local Inspection Report Is Required"));

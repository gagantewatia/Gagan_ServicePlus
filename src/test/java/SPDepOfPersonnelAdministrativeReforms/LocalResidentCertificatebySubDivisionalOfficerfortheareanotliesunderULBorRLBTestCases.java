...
public class LocalResidentCertificatebySubDivisionalOfficerfortheareanotliesunderULBorRLBTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoSubDivisionalOfficer().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Local Resident Certificate by Sub Divisional Officer for the area not lies under ULB or RLB","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Local Resident Certificate by Sub Divisional Officer for the area not lies under ULB or RLB"));

	...
	//go to department page	
		...
		
		{
			...
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in DepartmentofHealthJammuKashmir.");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in DepartmentofHealthJammuKashmir: " + cl.duplicateTestCases());
		     }
		}
		//check servcie count
		...
		public void servicecountfromexcel() throws IOException, InterruptedException
			...
			test.assignCategory(DepartmentofHealthJammuKashmir);
					commonlocators cl=new commonlocators(Driver);
				String x="Department of Health Jammu & Kashmir";

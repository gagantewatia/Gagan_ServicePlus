package SPDepartmentofHealthJammuKashmir;
...
import Pageobject.SPDepartmentofHealthJammuKashmir.DepartmentofHealthJammuKashmir;
import Resources.Base2;

public class ApplicationformforPhysicallyChallengedCertificateTestCases extends Base2
{
	...
	{
		test.assignCategory(DepartmentofHealthJammuKashmir);
...
//go to department page	
...

	{
		test.assignCategory(DepartmentofHealthJammuKashmir);
		 departmentnavigationpage SD=new departmentnavigationpage(Driver);
		 String Servicename="Department of Health Jammu & Kashmir";
	 	 SD.servicenavigationclick(Servicename);
		 Assert.assertEquals(SD.DepartmentofHealthJammuKashmir().getText(),"Department of Health Jammu & Kashmir","Not matched");
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				DepartmentofHealthJammuKashmir dp=new DepartmentofHealthJammuKashmir(Driver);
				dp.infoPhysicallyChallengedCertificate().click();
				test.log(Status.INFO,"Clicked on i icon"); 
				Assert.assertEquals(PQ.infoservicename2().getText(),"Application form for Physically Challenged Certificate","Not matched");
				PQ.desccheck();
	...
	dp.PhysicallyChallengedCertificate().click();
	Thread.sleep(2000);
	List<String> browserTabs = new ArrayList<String> (Driver.getWindowHandles());
	//switch to new tab
	...
	Assert.assertTrue(s.contains("Application form for Physically Challenged Certificate"));

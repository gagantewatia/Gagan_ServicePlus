...
public class ApplicationFormforAgeCertificateTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoAgeCertificate().click();
				test.log(Status.INFO,"Clicked on i icon"); 
				Assert.assertEquals(PQ.infoservicename2().getText(),"Application Form for Age Certificate","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Application Form for Age Certificate"));

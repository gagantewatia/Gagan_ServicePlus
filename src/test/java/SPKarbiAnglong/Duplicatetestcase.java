...
Assert.assertTrue(SD.DeptTagline().getText().contains("Service Plus Services")); 
		...
		
		{
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Karbi Anglong (AC)");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Karbi Anglong (AC) :  " + cl.duplicateTestCases());
		     }
		}

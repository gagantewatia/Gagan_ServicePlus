...
public class CertifiedCopyofMutationTestCase extends Base2
{
	...
	//go to department page	
		...
		//go to service and check heading
...

			{
					...
					dp.infoMutation().click();
					test.log(Status.INFO,"Clicked on i icon");
					Assert.assertEquals(PQ.infoservicename2().getText(),"Certified Copy of Mutation","Not matched");
					PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Certified Copy of Mutation"));

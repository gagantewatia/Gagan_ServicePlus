...
public class IssuanceofRenewalofBusinessRegistrationCertificateTestCase extends Base2
{
	...
	//go to department page	
		...
		//go to service and check heading
...

			{
					...
					dp.infoBusinessRegistration().click();
					test.log(Status.INFO,"Clicked on i icon");
					Assert.assertEquals(PQ.infoservicename2().getText(),"Issuance of Renewal of Business Registration Certificate","Not matched");
					PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Issuance of Renewal of Business Registration Certificate"));

...
public class IssuanceofFarmersCertificateTestCase extends Base2
{
	...
	//go to department page	
		...
		//go to service and check heading
...

			{
					...
					dp.infoFarmers().click();
					test.log(Status.INFO,"Clicked on i icon");
					Assert.assertEquals(PQ.infoservicename2().getText(),"Issuance of Farmer's Certificate","Not matched");
					PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Issuance of Farmer's Certificate"));

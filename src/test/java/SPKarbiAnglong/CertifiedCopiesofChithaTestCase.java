...
public class CertifiedCopiesofChithaTestCase extends Base2
{
...
//go to department page	
	...
	//go to service and check heading
...

		{
				...
				Assert.assertEquals(PQ.infoservicename2().getText(),"Certified Copies of Chitha","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Certified Copies of Chitha"));

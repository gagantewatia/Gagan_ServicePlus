...
public class LandRevenueClearanceCertificateTestCase extends Base2
{
...
//go to department page	
	...
	//go to department page	
		...
		//go to service and check heading
...

			{
					...
					dp.infoLandRevenue().click();
					test.log(Status.INFO,"Clicked on i icon");
					Assert.assertEquals(PQ.infoservicename2().getText(),"Land Revenue Clearance Certificate","Not matched");
					PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Land Revenue Clearance Certificate"));

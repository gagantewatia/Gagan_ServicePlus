...
public class CertifiedCopiesofJamabandiTestCase extends Base2
{
	...
	//go to department page	
		...
		//go to service and check heading
...

			{
					...
					dp.infoJamabandi().click();
					test.log(Status.INFO,"Clicked on i icon");
					Assert.assertEquals(PQ.infoservicename2().getText(),"Certified Copies of Jamabandi","Not matched");
					PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Certified Copies of Jamabandi"));

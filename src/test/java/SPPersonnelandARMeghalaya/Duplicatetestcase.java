	...
	//go to department page	
		...
		
		{
			...
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Personnel and A.R. Meghalaya");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Personnel and A.R. Meghalaya :  " + cl.duplicateTestCases());
		     }
		}
...

			{
				...
				commonlocators cl=new commonlocators(Driver);
			String x="Personnel and A.R. Meghalaya";

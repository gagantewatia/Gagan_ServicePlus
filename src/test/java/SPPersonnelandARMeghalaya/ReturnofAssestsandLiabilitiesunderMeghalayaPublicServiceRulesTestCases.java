package SPPersonnelandARMeghalaya;
...
import Pageobject.SPDirectorateOfTechnicalEducation.DirectorateOfTechnicalEducation;
import Pageobject.SPPersonnelandARMeghalaya.PersonnelandARMeghalaya;
import Resources.Base2;

public class ReturnofAssestsandLiabilitiesunderMeghalayaPublicServiceRulesTestCases extends Base2
{
	...
	{
		test.assignCategory(PersonnelandARMeghalaya);
...
//go to department page	
...

	{
		test.assignCategory(PersonnelandARMeghalaya);
		 departmentnavigationpage SD=new departmentnavigationpage(Driver);
		 String Servicename="Personnel and A.R. Meghalaya";
	 	 SD.servicenavigationclick(Servicename);
		 Assert.assertEquals(SD.PersonnelandARMeghalaya().getText(),"Personnel and A.R. Meghalaya","Not matched");
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				PersonnelandARMeghalaya dp=new PersonnelandARMeghalaya(Driver); 
				dp.infoMeghalayaPublic().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Return of Assests and Liabilities under Meghalaya Public Service Rules 2016","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Return of Assests and Liabilities under Meghalaya Public Service Rules 2016"));

...
public class IssuanceofDealerLicensefromLegalMetrologyUnitTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				Assert.assertEquals(PQ.infoservicename2().getText(),"Issuance of Dealer License from Legal Metrology Unit","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Issuance of Dealer License from Legal Metrology Unit"));

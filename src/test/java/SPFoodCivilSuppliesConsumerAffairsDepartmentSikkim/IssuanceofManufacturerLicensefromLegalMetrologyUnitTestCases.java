...
import Pageobject.SPFoodCivilSuppliesConsumerAffairsDepartmentSikkim.FoodCivilSuppliesConsumerAffairsDepartmentSikkim;
import Resources.Base2;

public class IssuanceofManufacturerLicensefromLegalMetrologyUnitTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				FoodCivilSuppliesConsumerAffairsDepartmentSikkim dp=new FoodCivilSuppliesConsumerAffairsDepartmentSikkim(Driver);
				dp.infoManufacturer().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Issuance of Manufacturer License from Legal Metrology Unit","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Issuance of Manufacturer License from Legal Metrology Unit"));

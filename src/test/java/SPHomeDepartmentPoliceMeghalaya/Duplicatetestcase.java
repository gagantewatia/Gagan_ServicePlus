	...
	//go to department page	
		...
		
		{
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Department of Science and Technology");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Department of Science and Technology :  " + cl.duplicateTestCases());
		     }
		}
		...
		public void servicecountfromexcel() throws IOException, InterruptedException
				{
					commonlocators cl=new commonlocators(Driver);
				String x="Department of Science and Technology Haryana";

package SPHomeDepartmentPoliceMeghalaya;
...
import Pageobject.SPHomeDepartmentPoliceMeghalaya.HomeDepartmentPoliceMeghalaya;
import Resources.Base2;

public class ProvisionalFireSafetyCertificateTestCases extends Base2
{
	...
	{
		test.assignCategory(HomeDepartmentPoliceMeghalaya);
...
//go to department page	
...

	{
		test.assignCategory(HomeDepartmentPoliceMeghalaya);
		 departmentnavigationpage SD=new departmentnavigationpage(Driver);
		 String Servicename="Home Department Police Meghalaya";
	 	 SD.servicenavigationclick(Servicename);
		 Assert.assertEquals(SD.HomeDepartmentPoliceMeghalaya().getText(),"Home Department Police Meghalaya","Not matched");
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				HomeDepartmentPoliceMeghalaya dp=new HomeDepartmentPoliceMeghalaya(Driver);
				dp.infoProvisionalFireSafety().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Provisional Fire Safety Certificate","Not matched");
				PQ.desccheck();
	...
	test.assignCategory(HomeDepartmentPoliceMeghalaya);
	HomeDepartmentPoliceMeghalaya dp=new HomeDepartmentPoliceMeghalaya(Driver);
	dp.ProvisionalFireSafety().click();
	Thread.sleep(2000);
	List<String> browserTabs = new ArrayList<String> (Driver.getWindowHandles());
	//switch to new tab
	...
	Assert.assertTrue(s.contains("Provisional Fire Safety Certificate"));

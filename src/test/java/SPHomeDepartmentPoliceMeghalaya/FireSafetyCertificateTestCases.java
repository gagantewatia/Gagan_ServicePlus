...
public class FireSafetyCertificateTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoFireSafety().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Fire Safety Certificate","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Fire Safety Certificate"));

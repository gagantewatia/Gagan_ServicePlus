...
public class AttendanceScholarshiptoGirlsStudentsFrom1stto5thClassTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoGirlsStudents().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Attendance Scholarship to Girls Students From 1st to 5th Class","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Attendance Scholarship to Girls Students From 1st to 5th Class"));

...
public class MeritScholarshipto9thClassStudentsonbasisof8thclassAnnualExamTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoAnnualExam().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Merit Scholarship to 9th Class Students on basis of 8th class Annual Exam","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Merit Scholarship to 9th Class Students on basis of 8th class Annual Exam"));

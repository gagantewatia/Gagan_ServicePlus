...
public class MeritScholarshipontheBasisof5thClassScholarshipExamTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoScholarshipExam().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Merit Scholarship on the Basis of 5th Class Scholarship Exam","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Merit Scholarship on the Basis of 5th Class Scholarship Exam"));

	...
	//go to department page	
		...
		
		{
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Directorate of School Education");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Directorate of School Education :  " + cl.duplicateTestCases());
		     }
		}
...

			{
				...
				commonlocators cl=new commonlocators(Driver);
			String x="Directorate of School Education";

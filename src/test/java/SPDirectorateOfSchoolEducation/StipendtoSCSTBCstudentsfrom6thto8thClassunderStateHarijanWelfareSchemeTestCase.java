package SPDirectorateOfSchoolEducation;
...
import Pageobject.SPDirectorateOfSchoolEducation.DirectorateOfSchoolEducation;
import Resources.Base2;

public class StipendtoSCSTBCstudentsfrom6thto8thClassunderStateHarijanWelfareSchemeTestCase extends Base2
{
	...
	{
		test.assignCategory(DirectorateOfSchoolEducation);
...
//go to department page	
...

	{
		test.assignCategory(DirectorateOfSchoolEducation);
		 departmentnavigationpage SD=new departmentnavigationpage(Driver);
		 String Servicename="Directorate of School Education Chandigarh";
	 	 SD.servicenavigationclick(Servicename);
		 Assert.assertEquals(SD.DirectorateOfSchoolEducation().getText(),"Directorate of School Education Chandigarh","Not matched");
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				DirectorateOfSchoolEducation dp=new DirectorateOfSchoolEducation(Driver); 
				dp.infoHarijanWelfareScheme().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Stipend to SC/ST/BC students from 6th to 8th Class under State Harijan Welfare Scheme","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Stipend to SC/ST/BC students from 6th to 8th Class under State Harijan Welfare Scheme"));

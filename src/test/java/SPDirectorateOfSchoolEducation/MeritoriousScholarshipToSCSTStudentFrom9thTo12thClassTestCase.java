...
public class MeritoriousScholarshipToSCSTStudentFrom9thTo12thClassTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoMeritoriousScholarship().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Meritorious Scholarship To SC ST Student From 9th To 12th Class","Not matched");
				PQ.desccheck();
	...
	test.assignCategory(DirectorateOfSchoolEducation);
	DirectorateOfSchoolEducation dp=new DirectorateOfSchoolEducation(Driver);
	dp.MeritoriousScholarship().click();
	Thread.sleep(2000);
	List<String> browserTabs = new ArrayList<String> (Driver.getWindowHandles());
	//switch to new tab
	...
	Assert.assertTrue(s.contains("Meritorious Scholarship To SC ST Student From 9th To 12th Class"));

...
public class AttendanceScholarshiptoSCSTStudentsfrom1stto8thClassTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoSCSTStudents().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Attendance Scholarship to SC ST Students from 1st to 8th Class","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Attendance Scholarship to SC ST Students from 1st to 8th Class"));

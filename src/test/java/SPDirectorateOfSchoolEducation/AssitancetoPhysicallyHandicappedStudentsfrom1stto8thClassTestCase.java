...
import Pageobject.SPFoodSuppliesDepartmentHaryana.FoodSuppliesDepartmentHaryana;
import Resources.Base2;

public class AssitancetoPhysicallyHandicappedStudentsfrom1stto8thClassTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				Assert.assertEquals(PQ.infoservicename2().getText(),"Assitance to Physically Handicapped Students from 1st to 8th Class","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Assitance to Physically Handicapped Students from 1st to 8th Class"));

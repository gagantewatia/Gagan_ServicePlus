...
public class FreeUniformandExerciseNotebookstoschoolchildrenuptoElementaryClassesTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoFreeUniform().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Free Uniform and Exercise Notebooks to school children upto Elementary Classes","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Free Uniform and Exercise Notebooks to school children upto Elementary Classes"));

	...
	//go to department page	
		...
		
		{
			...
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Department of Forest Tripura.");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Department of Forest Tripura: " + cl.duplicateTestCases());
		     }
		}
		//check servcie count
...

				{
					test.assignCategory(DepartmentofForestTripura);
					commonlocators cl=new commonlocators(Driver);
				String x="Department of Forest Tripura";

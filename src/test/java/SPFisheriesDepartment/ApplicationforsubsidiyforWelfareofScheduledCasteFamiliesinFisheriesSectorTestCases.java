...
public class ApplicationforsubsidiyforWelfareofScheduledCasteFamiliesinFisheriesSectorTestCases extends Base2
{
   //go to all services
	@Test(priority=1)
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoFamiliesinFisheries().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Application for subsidiy for Welfare of Scheduled Caste Families in Fisheries Sector","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Application for subsidiy for Welfare of Scheduled Caste Families in Fisheries Sector"));

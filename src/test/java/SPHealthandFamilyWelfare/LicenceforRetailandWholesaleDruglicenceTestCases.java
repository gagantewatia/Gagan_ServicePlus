package SPHealthandFamilyWelfare;
...
import Pageobject.SPHealthandFamilyWelfare.HealthandFamilyWelfare;
import Resources.Base2;

public class LicenceforRetailandWholesaleDruglicenceTestCases extends Base2
{
	...
	{
		test.assignCategory(HealthandFamilyWelfare);
...
//go to department page	
...

	{
		test.assignCategory(HealthandFamilyWelfare);
		 departmentnavigationpage SD=new departmentnavigationpage(Driver);
		 String Servicename="Health and Family Welfare";
	 	 SD.servicenavigationclick(Servicename);
		 Assert.assertEquals(SD.HealthandFamilyWelfare().getText(),"Health and Family Welfare","Not matched");
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				HealthandFamilyWelfare dp=new HealthandFamilyWelfare(Driver);
				dp.infoWholesale().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Licence for Retail and Wholesale Drug licence","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Licence for Retail and Wholesale Drug licence"));

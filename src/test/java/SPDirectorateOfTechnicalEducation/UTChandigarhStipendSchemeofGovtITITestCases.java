package SPDirectorateOfTechnicalEducation;
...
import Pageobject.SPEducationDepartment.EducationDepartment;
import Resources.Base2;

public class UTChandigarhStipendSchemeofGovtITITestCases extends Base2
{
	...
	{
		test.assignCategory(DirectorateOfTechnicalEducation);
...
//go to department page	
...

	{
		test.assignCategory(DirectorateOfTechnicalEducation);
		 departmentnavigationpage SD=new departmentnavigationpage(Driver);
		 String Servicename="Directorate of Technical Education Chandigarh";
	 	 SD.servicenavigationclick(Servicename);
		 Assert.assertEquals(SD.DirectorateOfTechnicalEducation().getText(),"Directorate of Technical Education Chandigarh","Not matched");
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				DirectorateOfTechnicalEducation dp=new DirectorateOfTechnicalEducation(Driver); 
				dp.infoUTChandigarh().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"UT Chandigarh Stipend Scheme of Govt. ITI","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("UT Chandigarh Stipend Scheme of Govt. ITI"));

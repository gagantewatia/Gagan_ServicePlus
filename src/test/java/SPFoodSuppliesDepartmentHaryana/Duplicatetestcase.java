	...
	//go to department page	
		...
		
		{
			...
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Food Supplies Department Haryana.");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Food Supplies Department Haryana: " + cl.duplicateTestCases());
		     }
...

		{
			test.assignCategory(FoodSuppliesDepartmentHaryana);
			commonlocators cl=new commonlocators(Driver);
		String x="Food & Supplies Department Haryana";

package SPFoodSuppliesDepartmentHaryana;
...
//go to department page	
...

	{
		test.assignCategory(FoodSuppliesDepartmentHaryana);
		 departmentnavigationpage SD=new departmentnavigationpage(Driver);
		 String Servicename="Food & Supplies Department Haryana";
	 	 SD.servicenavigationclick(Servicename);
		 Assert.assertEquals(SD.FoodSuppliesDepartmentHaryana().getText(),"Food & Supplies Department Haryana","Not matched");
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				FoodSuppliesDepartmentHaryana dp=new FoodSuppliesDepartmentHaryana(Driver); 
				dp.infoPovertyLine().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Issuance of New Above Poverty Line (APL) Ration Card","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Issuance of New Above Poverty Line (APL) Ration Card"));

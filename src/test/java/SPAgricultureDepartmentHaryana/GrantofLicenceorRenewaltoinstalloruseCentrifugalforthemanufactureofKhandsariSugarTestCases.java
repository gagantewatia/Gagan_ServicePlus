...
public class GrantofLicenceorRenewaltoinstalloruseCentrifugalforthemanufactureofKhandsariSugarTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoKhandsariSugar().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Grant of Licence or Renewal to install or use Centrifugal for the manufacture of Khandsari Sugar","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Grant of Licence or Renewal to install or use Centrifugal for the manufacture of Khandsari Sugar"));

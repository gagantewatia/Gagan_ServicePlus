...
public class LicenseofPesticidesDistrictLevelTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoLicenseofPesticides().click();
				test.log(Status.INFO,"Clicked on i icon"); 
				Assert.assertEquals(PQ.infoservicename2().getText(),"License of Pesticides - District Level","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("License of Pesticides - District Level"));

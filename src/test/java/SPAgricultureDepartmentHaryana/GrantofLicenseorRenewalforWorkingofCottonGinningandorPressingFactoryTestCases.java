...
public class GrantofLicenseorRenewalforWorkingofCottonGinningandorPressingFactoryTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				Assert.assertEquals(PQ.infoservicename2().getText(),"Grant of License or Renewal for Working of Cotton Ginning and/or Pressing Factory","Not matched");
				PQ.desccheck();
	...
	test.assignCategory(AgricultureDepartmentHaryana);
	AgricultureDepartmentHaryana dp=new AgricultureDepartmentHaryana(Driver);
	dp.CottonGinningPressingFactory().click();
	Thread.sleep(2000);
	...
	Assert.assertTrue(s.contains("Grant of License or Renewal for Working of Cotton Ginning and/or Pressing Factory"));

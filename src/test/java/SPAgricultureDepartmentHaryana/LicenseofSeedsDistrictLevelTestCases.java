...
public class LicenseofSeedsDistrictLevelTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoLicenseofSeeds().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"License of Seeds - District Level","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("License of Seeds - District Level"));

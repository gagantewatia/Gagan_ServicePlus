...
public class RenewalORDuplicateORAmendmentinAcknowledgmentofReceiptAuthorizationletterofFertilizerDealerServicesDistrictlevTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoFertilizerDealerServices().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Renewal OR Duplicate OR Amendment in Acknowledgment of Receipt/Authorization letter of Fertilizer Dealer Services - District lev","Not matched");
				PQ.desccheck();
	...
	test.assignCategory(AgricultureDepartmentHaryana);
	AgricultureDepartmentHaryana dp=new AgricultureDepartmentHaryana(Driver);
	dp.FertilizerDealerServices().click();
	Thread.sleep(2000);
	...
	Assert.assertTrue(s.contains("Renewal OR Duplicate OR Amendment in Acknowledgment of Receipt/Authorization letter of Fertilizer Dealer Services - District level"));

	...
	//go to department page	
		...
		
		{
			...
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Agriculture Department Haryana.");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Agriculture Department Haryana: " + cl.duplicateTestCases());
		     }
		}
		
		//check servcie from excel 
...

				{
					test.assignCategory(AgricultureDepartmentHaryana);
					commonlocators cl=new commonlocators(Driver);
				String x="Agriculture Department Haryana";

...
public class GrantOfLicenseorRenewaltoInstallAPowerCrusherForManufacturerOfGurTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoPowerCrusher().click();
				test.log(Status.INFO,"Clicked on i icon"); 
				Assert.assertEquals(PQ.infoservicename2().getText(),"Grant Of License or Renewal to Install A Power Crusher For Manufacturer Of Gur","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Grant Of License or Renewal to Install A Power Crusher For Manufacturer Of Gur"));

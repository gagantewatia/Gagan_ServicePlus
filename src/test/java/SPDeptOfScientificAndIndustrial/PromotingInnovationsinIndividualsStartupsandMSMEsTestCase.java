...
public class PromotingInnovationsinIndividualsStartupsandMSMEsTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoPromotingInnovations().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Promoting Innovations in Individuals Start-ups and MSMEs","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Promoting Innovations in Individuals Start-ups and MSMEs"));

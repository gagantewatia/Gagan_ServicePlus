	...
	//go to department page	
		...
		
		{
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Department of Scientific and Industrial Research");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Department of Scientific and Industrial Research :  " + cl.duplicateTestCases());
		     }
		}
		...
		//check servcie count
				...
				{
					commonlocators cl=new commonlocators(Driver);
				String x="Department of Scientific and Industrial Research Delhi";

package SPDeptOfScientificAndIndustrial;
...
import Pageobject.SPDepOfScientificAndIndustrial.DepOfScientificAndIndustrial;
import Resources.Base2;

public class TechnologyDevelopmentandUtilizationProgrammeforWomenTDUPWTestCase extends Base2
{
...
//go to department page	
...

	{
		test.assignCategory(DepOfScientificAndIndustrial);
		 departmentnavigationpage SD=new departmentnavigationpage(Driver);
		 String Servicename="Department of Scientific and Industrial Research Delhi";
	 	 SD.servicenavigationclick(Servicename);
		 Assert.assertEquals(SD.DepOfScientificAndIndustrial().getText(),"Department of Scientific and Industrial Research Delhi","Not matched");
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				DepOfScientificAndIndustrial dp=new DepOfScientificAndIndustrial(Driver);
				dp.infoTechnologyDevelopment().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Technology Development and Utilization Programme for Women - TDUPW","Not matched");
				PQ.desccheck();
	...
	test.assignCategory(DepOfScientificAndIndustrial);
	DepOfScientificAndIndustrial dp=new DepOfScientificAndIndustrial(Driver);
	dp.TechnologyDevelopment().click();
	Thread.sleep(2000);
	List<String> browserTabs = new ArrayList<String> (Driver.getWindowHandles());
	//switch to new tab
	...
	Assert.assertTrue(s.contains("Technology Development and Utilization Programme for Women - TDUPW"));

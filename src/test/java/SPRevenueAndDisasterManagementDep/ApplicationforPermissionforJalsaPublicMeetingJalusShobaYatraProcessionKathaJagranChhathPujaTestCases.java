...
public class ApplicationforPermissionforJalsaPublicMeetingJalusShobaYatraProcessionKathaJagranChhathPujaTestCases extends Base2
{
...
//go to department page	
...

	{
			...
			dp.infoChhathPuja().click();
			test.log(Status.INFO,"Clicked on i icon");
			Assert.assertEquals(PQ.infoservicename2().getText(),"Application for Permission for Jalsa/ Public Meeting/ Jalus/ Shoba Yatra/ Procession/ Katha/ Jagran/ Chhath Puja","Not matched");
			PQ.desccheck();
...
@Test(priority=6,dependsOnMethods = {"DeptNavigation"})
	...
	Assert.assertTrue(s.contains("Application for Permission for Jalsa/ Public Meeting/ Jalus/ Shoba Yatra/ Procession/ Katha/ Jagran/ Chhath Puja"));

...
public class ExGratiaAssistancetoNextofKinoftheDeceasedbyCOVID19TestCases extends Base2
{
...
@Test(priority=6,dependsOnMethods = {"DeptNavigation"})
	...
	Assert.assertTrue(s.contains("Ex Gratia Assistance to Next of Kin of the Deceased by COVID-19"));

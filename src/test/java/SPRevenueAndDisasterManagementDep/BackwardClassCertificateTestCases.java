...
public class BackwardClassCertificateTestCases extends Base2
{
...
//go to department page	
	...
	Assert.assertTrue(s.contains("Backward Class Certificate/पिछड़ा वर्ग प्रमाण पत्र"));

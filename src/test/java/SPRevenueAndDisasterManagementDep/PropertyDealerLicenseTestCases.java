...
public class PropertyDealerLicenseTestCases extends Base2
{
...
//go to department page	
...

	{
			...
			dp.infoPropertyDealer().click();
			test.log(Status.INFO,"Clicked on i icon");
			Assert.assertEquals(PQ.infoservicename2().getText(),"Property Dealer License","Not matched");
			PQ.desccheck();
...
@Test(priority=6,dependsOnMethods = {"DeptNavigation"})
	...
	Assert.assertTrue(s.contains("Property Dealer License"));

...
public class ApplicationforPermissionforLoudspeakerDJTestCases extends Base2
{
...
//go to department page	
...

	{
			...
			dp.infoLoudspeaker().click();
			test.log(Status.INFO,"Clicked on i icon");
			Assert.assertEquals(PQ.infoservicename2().getText(),"Application for Permission for Loudspeaker/DJ लाउडस्पीकर/डीजे की अनुमति के लिए आवेदन","Not matched");
			PQ.desccheck();
...
@Test(priority=6,dependsOnMethods = {"DeptNavigation"})
	...
	Assert.assertTrue(s.contains("Application for Permission for Loudspeaker/DJ लाउडस्पीकर/डीजे की अनुमति के लिए आवेदन"));

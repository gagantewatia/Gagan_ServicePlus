	...
	//go to department page	
		...
		
		{
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Revenue and Disaster Management Department");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Revenue and Disaster Management Department :  " + cl.duplicateTestCases());
		     }
		}

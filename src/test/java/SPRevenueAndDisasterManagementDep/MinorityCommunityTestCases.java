...
public class MinorityCommunityTestCases extends Base2
{
...
//go to department page	
...

	{
			...
			dp.infoMinorityCommunity().click();
			test.log(Status.INFO,"Clicked on i icon");
			Assert.assertEquals(PQ.infoservicename2().getText(),"Minority Community","Not matched");
			PQ.desccheck();
...
@Test(priority=6,dependsOnMethods = {"DeptNavigation"})
	...
	Assert.assertTrue(s.contains("Minority Community"));

...
public class TournamentsGamesTestCases extends Base2
{
...
//go to department page	
...

	{
			...
			Thread.sleep(2000);
			dp.infoTournaments().click();
			test.log(Status.INFO,"Clicked on i icon");
			Assert.assertEquals(PQ.infoservicename2().getText(),"Tournaments/ Games","Not matched");
			PQ.desccheck();
...
@Test(priority=6,dependsOnMethods = {"DeptNavigation"})
	...
	Assert.assertTrue(s.contains("Tournaments/ Games"));

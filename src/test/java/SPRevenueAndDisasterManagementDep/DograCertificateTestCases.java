...
public class DograCertificateTestCases extends Base2
{
...
//go to department page	
...

	{
			...
			dp.infoDograCertificate().click();
			test.log(Status.INFO,"Clicked on i icon");
			Assert.assertEquals(PQ.infoservicename2().getText(),"Dogra Certificate","Not matched");
			PQ.desccheck();

...
public class EconomicallyWeakerSectionEWSCertificateforAllotmentofResidentialFlatorResidentialPlotbyHousingBoardTestCases2 extends Base2
{
...
//go to department page	
	...
	Assert.assertTrue(s.contains("Economically Weaker Section (EWS) Certificate for Allotment of Residential Flat or Residential Plot by Housing Board"));

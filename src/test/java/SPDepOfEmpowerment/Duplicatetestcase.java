	...
	//go to department page	
		...
		
		{
			...
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Department Of Empowerment Of Persons With Disabilities");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Department Of Empowerment Of Persons With Disabilities :  " + cl.duplicateTestCases());
		     }
		}
		...
		//check servcie count
...

				{
					test.assignCategory(DepOfEmpowerment);
					commonlocators cl=new commonlocators(Driver);
				String x="Department Of Empowerment Of Persons With Disabilities";

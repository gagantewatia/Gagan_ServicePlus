...
import PageObjects.SPCCET.CCET;
import Resources.Base2;

public class ScholarshipTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				CCET dp=new CCET(Driver);
				dp.infoScholarship().click();
				test.log(Status.INFO,"Clicked on i icon"); 
				Assert.assertEquals(PQ.infoservicename2().getText(),"Scholarship to Meritorious and SC/ST Students of CCET Chandigarh","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Scholarship to Meritorious and SC/ST Students of CCET Chandigarh"));

package SPCCET;
	...
	//go to department page	
		...
		public void Deptnavigation() throws IOException, InterruptedException
		{
			test.assignCategory(CCET);
			 departmentnavigationpage SD=new departmentnavigationpage(Driver);
			 String Servicename="CCET Chandigarh";
		 	 SD.servicenavigationclick(Servicename);
			 Assert.assertEquals(SD.CCET().getText(), "CCET Chandigarh","Not matched");
		...
		
		{
			...
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in CCET (Degree Wing)");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in CCET (Degree Wing) " + cl.duplicateTestCases());
		     }
		}

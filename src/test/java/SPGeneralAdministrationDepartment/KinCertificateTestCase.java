...
public class KinCertificateTestCase extends Base2
{
...
//go to department page	
	...
	@Test(priority=2)
	public void KinCertificatenavigation() throws IOException, InterruptedException
	...
	@Test(priority=3)
	public void KinCertificate1TestCases() throws IOException, InterruptedException
	
	{
	test.assignCategory(GeneralAdministrationDepartment);
	GeneralAdministrationDepartment dp=new GeneralAdministrationDepartment(Driver);
	dp.KinCertificate().click();
	Thread.sleep(2000);
	...
	@Test(priority=4)
	public void KinCertificate2TestCase() throws IOException, InterruptedException
	...
	Assert.assertTrue(s.contains("Issuance of Next of Kin Certificate"));

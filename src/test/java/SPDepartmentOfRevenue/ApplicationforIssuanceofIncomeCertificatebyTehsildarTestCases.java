...
public class ApplicationforIssuanceofIncomeCertificatebyTehsildarTestCases extends Base2
{
...
//go to department page	
	...
	Assert.assertTrue(s.contains("Application for Issuance of Income Certificate by Tehsildar"));

...
public class ApplicationforIssuanceofLegalHeirCertificatebyTehsildarTestCases extends Base2
{
...
//go to department page	
	...
	Assert.assertTrue(s.contains("Application for Issuance of Legal Heir Certificate by Tehsildar"));

...
public class ApplicationforIssuanceofCharacterCertificatebyTehsildarTestCases extends Base2
{
...
//go to department page	
	...
	Assert.assertTrue(s.contains("Application for Issuance of Character Certificate by Tehsildar"));

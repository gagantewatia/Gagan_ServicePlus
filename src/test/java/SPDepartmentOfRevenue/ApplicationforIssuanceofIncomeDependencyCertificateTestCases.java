...
public class ApplicationforIssuanceofIncomeDependencyCertificateTestCases extends Base2
{
...
//go to department page	
	...
	@Test(priority=2)
	public void DeptNavigationnavigation() throws IOException, InterruptedException
	{
		test.assignCategory(DepartmentOfRevenue);
		 departmentnavigationpage SD=new departmentnavigationpage(Driver);
	...
	dp.IncomeDependencyCertificate().click();
	Thread.sleep(2000);
	...
	Assert.assertTrue(s.contains("Application for Issuance of Income Dependency Certificate"));

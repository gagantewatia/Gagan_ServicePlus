...
public class ApplicationforIssuanceofPahariEthnicPeopleCategoryCertificateTestCases extends Base2
{
...
//go to department page	
	...
	Assert.assertTrue(s.contains("Application for Issuance of Pahari Ethnic People Category Certificate"));

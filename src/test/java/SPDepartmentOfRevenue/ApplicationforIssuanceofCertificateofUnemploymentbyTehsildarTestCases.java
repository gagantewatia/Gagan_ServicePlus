...
public class ApplicationforIssuanceofCertificateofUnemploymentbyTehsildarTestCases extends Base2
{
...
//go to department page	
	...
	dp.CertificateofUnemployment().click();
	Thread.sleep(2000);
	...
	Assert.assertTrue(s.contains("Application for Issuance of Certificate of Unemployment by Tehsildar"));

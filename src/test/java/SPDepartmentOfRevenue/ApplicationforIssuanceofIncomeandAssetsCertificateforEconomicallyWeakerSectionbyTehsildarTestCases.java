...
public class ApplicationforIssuanceofIncomeandAssetsCertificateforEconomicallyWeakerSectionbyTehsildarTestCases extends Base2
{
...
//go to department page	
	...
	Assert.assertTrue(s.contains("Application for Issuance of Income and Assets Certificate for Economically Weaker Section by Tehsildar"));

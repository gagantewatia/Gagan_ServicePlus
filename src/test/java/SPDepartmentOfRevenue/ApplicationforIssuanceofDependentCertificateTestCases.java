...
public class ApplicationforIssuanceofDependentCertificateTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				PQ.seeinfo3iconflat().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename().getText(),"Application for Issuance of Dependent Certificate","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Application for Issuance of Dependent Certificate"));

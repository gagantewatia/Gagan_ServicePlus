...
public class ApplicationforIssuanceofCertificateforBeingaMemberofScheduledCasteScheduledTribebyTehsildarTestCases extends Base2
{
...
//go to department page	
	...
	Assert.assertTrue(s.contains("Application for Issuance of Certificate for Being a Member of Scheduled Caste / Scheduled Tribe by Tehsildar - SC / ST Certificate"));

...
public class FinancialAssistanceUnderScheduledCastesScheduledTribesTestCases extends Base2
{
   //go to all services
	@Test(priority=1)
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				Assert.assertEquals(PQ.infoservicename2().getText(),"Financial Assistance Under Scheduled Castes/Scheduled Tribes(Prevention Of Atrocities) Rules.1995","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Financial Assistance Under Scheduled Castes/Scheduled Tribes(Prevention Of Atrocities) Rules.1995"));

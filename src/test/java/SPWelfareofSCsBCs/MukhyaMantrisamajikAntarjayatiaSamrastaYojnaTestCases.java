...
public class MukhyaMantrisamajikAntarjayatiaSamrastaYojnaTestCases extends Base2
{
   //go to all services
	@Test(priority=1)
...
//go to department page	
	...
	Assert.assertTrue(s.contains("Mukhya Mantri samajik Antarjayatia Samrasta Yojna"));

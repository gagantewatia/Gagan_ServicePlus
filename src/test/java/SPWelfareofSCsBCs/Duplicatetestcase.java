	...
	//go to department page	
		...
		
		{
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Welfare of SCs & BCs");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Welfare of SCs & BCs :  " + cl.duplicateTestCases());
		     }
		}

	...
	//go to department page	
		...
		
		{
			...
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Urban Dev Housing Department Sikkim");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Urban Dev. Housing Department Sikkim " + cl.duplicateTestCases());
		     }
		}
		...
		{
			commonlocators cl=new commonlocators(Driver);
		String x="Urban Dev. Housing Department Sikkim";

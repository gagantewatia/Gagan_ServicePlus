...
public class IssuanceofPermissionforBannerPlacementTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoBannerPlacement().click();
				test.log(Status.INFO,"Clicked on i icon"); 
				Assert.assertEquals(PQ.infoservicename2().getText(),"Issuance of Permission for Banner Placement","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Issuance of Permission for Banner Placement"));

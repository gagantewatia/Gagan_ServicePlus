...
public class AllotmentofTemporaryPermissionforMegaEventsfromUDDTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoTemporaryPermission().click();
				test.log(Status.INFO,"Clicked on i icon"); 
				Assert.assertEquals(PQ.infoservicename2().getText(),"Allotment of Temporary Permission for Mega Events from UDD","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Allotment of Temporary Permission for Mega Events from UDD"));

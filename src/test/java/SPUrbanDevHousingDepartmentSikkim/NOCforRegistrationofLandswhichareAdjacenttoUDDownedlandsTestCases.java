...
public class NOCforRegistrationofLandswhichareAdjacenttoUDDownedlandsTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoUDDownedlands().click();
				test.log(Status.INFO,"Clicked on i icon"); 
				Assert.assertEquals(PQ.infoservicename2().getText(),"NOC for Registration of Lands which are Adjacent to UDD owned lands","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("NOC for Registration of Lands which are Adjacent to UDD owned lands"));

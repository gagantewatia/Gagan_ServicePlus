...
public class NOCforAvailingHousingLoanonMortgageofLeaseDeedfromUDDTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoLeaseDeed().click();
				test.log(Status.INFO,"Clicked on i icon"); 
				Assert.assertEquals(PQ.infoservicename2().getText(),"NOC for Availing Housing Loan on Mortgage of Lease Deed from UDD","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("NOC for Availing Housing Loan on Mortgage of Lease Deed from UDD"));

...
public class IssuanceofMgMargPermissionforProfitableEventsTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoProfitableEvents().click();
				test.log(Status.INFO,"Clicked on i icon"); 
				Assert.assertEquals(PQ.infoservicename2().getText(),"Issuance of MgMarg Permission for Profitable Events","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Issuance of MgMarg Permission for Profitable Events"));

...
public class AllotmentofShopRoomsPublicSpaceHousingUnitforBusinessPurposesfromUDDTestCases2 extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoBusinessPurposes().click();
				test.log(Status.INFO,"Clicked on i icon"); 
				Assert.assertEquals(PQ.infoservicename2().getText(),"Allotment of Shop Rooms/Public Space/Housing Unit for Business Purposes from UDD","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Allotment of Shop Rooms/Public Space/Housing Unit for Business Purposes from UDD"));

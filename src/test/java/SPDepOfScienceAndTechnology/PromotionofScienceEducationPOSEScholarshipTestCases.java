package SPDepOfScienceAndTechnology;
...
import Pageobject.SPDepOfScienceAndTechnology.DepOfScienceAndTechnology;
import Resources.Base2;

public class PromotionofScienceEducationPOSEScholarshipTestCases extends Base2
{
	...
	{
		test.assignCategory(DepOfScienceAndTechnology);
...
//go to department page	
...

	{
		test.assignCategory(DepOfScienceAndTechnology);
		 departmentnavigationpage SD=new departmentnavigationpage(Driver);
		 String Servicename="Department of Science and Technology Haryana";
	 	 SD.servicenavigationclick(Servicename);
		 Assert.assertEquals(SD.DepOfScienceAndTechnology().getText(),"Department of Science and Technology Haryana","Not matched");
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				DepOfScienceAndTechnology dp=new DepOfScienceAndTechnology(Driver);
				dp.infoScienceEducation().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Promotion of Science Education (POSE) Scholarship","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Promotion of Science Education (POSE) Scholarship"));

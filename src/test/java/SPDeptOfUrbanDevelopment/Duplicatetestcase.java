	...
	//go to department page	
		...
		
		{
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Department Of Urban Development");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Department Of Urban Development :  " + cl.duplicateTestCases());
		     }
		}
		//check servcie count
				...
				{
					commonlocators cl=new commonlocators(Driver);
				String x="Department Of Urban Development Tripura";

...
public class RegistrationofDogTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				Assert.assertEquals(PQ.infoservicename2().getText(),"Registration of Dog","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Registration of Dog"));
	//close and return to browser1
	List<String> browserTabs = new ArrayList<String> (Driver.getWindowHandles());

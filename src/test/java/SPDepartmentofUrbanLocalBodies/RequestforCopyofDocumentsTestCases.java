...
public class RequestforCopyofDocumentsTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoDocuments().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Request for Copy of Documents","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Request for Copy of Documents"));
	//close and return to browser1
	List<String> browserTabs = new ArrayList<String> (Driver.getWindowHandles());

...
public class LicenseforDhobisforusingMunicipalDhobiGhatsTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				Assert.assertEquals(PQ.infoservicename2().getText(),"License for Dhobis for using Municipal Dhobi Ghats","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("License for Dhobis for using Municipal Dhobi Ghats"));
	//close and return to browser1
	List<String> browserTabs = new ArrayList<String> (Driver.getWindowHandles());

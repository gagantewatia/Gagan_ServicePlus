...
public class BookingofCommunityCenterTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoCommunity().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Booking of Community Center","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Booking of Community Center"));
	//close and return to browser1
	List<String> browserTabs = new ArrayList<String> (Driver.getWindowHandles());

...
public class LicensetoRunFlourMillTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				Assert.assertEquals(PQ.infoservicename2().getText(),"License to Run Flour Mill","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("License to Run Flour Mill"));
	//close and return to browser1
	List<String> browserTabs = new ArrayList<String> (Driver.getWindowHandles());

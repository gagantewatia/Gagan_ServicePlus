	...
	//go to department page	and check tag line
...

		{
			test.assignCategory(DepartmentofUrbanLocalBodies);
			 departmentnavigationpage SD=new departmentnavigationpage(Driver);
			 String Servicename="Department of Urban Local Bodies- Haryana";
		...
		
		{
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Department of Urban Local Bodies- Haryana.");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Department of Urban Local Bodies- Haryana: " + cl.duplicateTestCases());
		     }
		}
		...
		{
			commonlocators cl=new commonlocators(Driver);
		String x="Department of Urban Local Bodies Haryana";

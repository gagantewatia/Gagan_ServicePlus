...
public class PermissionforInstallationofTemporaryStructureTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoTemporary().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Permission for Installation of Temporary Structure","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Permission for Installation of Temporary Structure"));
	//close and return to browser1
	List<String> browserTabs = new ArrayList<String> (Driver.getWindowHandles());

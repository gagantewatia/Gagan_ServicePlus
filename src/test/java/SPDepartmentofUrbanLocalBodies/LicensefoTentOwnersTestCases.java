...
public class LicensefoTentOwnersTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				Assert.assertEquals(PQ.infoservicename2().getText(),"License for Tent Owners","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("License for Tent Owners"));
	//close and return to browser1
	List<String> browserTabs = new ArrayList<String> (Driver.getWindowHandles());

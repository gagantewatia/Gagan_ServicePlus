...
public class ApplyforDisconnectionofWaterSewerConnectioninUrbanLocalBodiesTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				Assert.assertEquals(PQ.infoservicename2().getText(),"Apply for Disconnection of Water/Sewer Connection in Urban Local Bodies","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Apply for Disconnection of Water/Sewer Connection in Urban Local Bodies"));
	//close and return to browser1
	List<String> browserTabs = new ArrayList<String> (Driver.getWindowHandles());

...
public class IssueofConveyanceDeedinMunicipalCorporationMunicipalCouncilsandMunicipalCommitteesTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				Assert.assertEquals(PQ.infoservicename2().getText(),"Issue of Conveyance Deed in Municipal Corporation, Municipal Councils and Municipal Committees","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Issue of Conveyance Deed in Municipal Corporation, Municipal Councils and Municipal Committees"));
	//close and return to browser1
	List<String> browserTabs = new ArrayList<String> (Driver.getWindowHandles());

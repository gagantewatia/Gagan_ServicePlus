...
public class LicenseforAeratedWaterIceandIceCreamFactoryTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoAerated().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"License for Aerated Water, Ice and Ice Cream Factory","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("License for Import of MeatLicense for Aerated Water, Ice and Ice Cream Factory"));
	//close and return to browser1
	List<String> browserTabs = new ArrayList<String> (Driver.getWindowHandles());

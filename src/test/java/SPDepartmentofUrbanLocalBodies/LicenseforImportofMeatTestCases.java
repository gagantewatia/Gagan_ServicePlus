...
public class LicenseforImportofMeatTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoImportofMeat().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"License for Import of Meat","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("License for Import of Meat"));
	//close and return to browser1
	List<String> browserTabs = new ArrayList<String> (Driver.getWindowHandles());

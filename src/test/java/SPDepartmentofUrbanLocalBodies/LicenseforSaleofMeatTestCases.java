...
public class LicenseforSaleofMeatTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				Assert.assertEquals(PQ.infoservicename2().getText(),"License for Sale of Meat","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("License for Sale of Meat"));
	//close and return to browser1
	List<String> browserTabs = new ArrayList<String> (Driver.getWindowHandles());

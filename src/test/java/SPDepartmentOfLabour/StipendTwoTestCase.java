...
public class StipendTwoTestCase extends Base2
{
...
//go to department page	
	...
	@Test(priority=2)
	public void StipendTwonavigation() throws IOException, InterruptedException
	...
	@Test(priority=3,dependsOnMethods = {"StipendTwonavigation"})
	public void StipendTwo1TestCases() throws IOException, InterruptedException
	...
	public void StipendTwo2TestCase() throws IOException, InterruptedException
	...
	Assert.assertTrue(s.contains("Stipend to ITI Trainees"));

package SPDepartmentOfLabour;
	...
	//go to department page	and check tagline 
		...
		
		{
			...
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Department of Labour, Employment and Training.");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Department of Labour, Employment and Training: " + cl.duplicateTestCases());
		     }
		}
		...
		//check servcie count
...

				{
					test.assignCategory(DepartmentOfLabour);
					commonlocators cl=new commonlocators(Driver);
				String x="Department of Labour, Employment and Training";

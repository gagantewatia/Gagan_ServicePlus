...
public class StipendtoITITraineesTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				Thread.sleep(2000);
				dp.infoStipendOne().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Stipend to ITI Trainees","Not matched");
				PQ.desccheck();

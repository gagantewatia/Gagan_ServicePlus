...
public class DisabilityFinancialAssistanceTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				Infopage PQ=new Infopage(Driver);
				 ...
				 Thread.sleep(2000);
				dp.infoDisability().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Disability Financial Assistance","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Disability Financial Assistance"));

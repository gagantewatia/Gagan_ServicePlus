...
public class MaternityFinancialBenefitTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				Thread.sleep(2000);
				dp.infoMaternity().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Maternity Financial Benefit","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Maternity Financial Benefit"));

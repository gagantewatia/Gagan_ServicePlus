...
public class FuneralFinancialAssistanceTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				Thread.sleep(2000);
				dp.infoFuneral().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Funeral Financial Assistance","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Funeral Financial Assistance"));

...
public class SkillDevelopmentFinancialBenefitTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				Thread.sleep(2000);
				dp.infoSkillDevelopment().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Skill Development Financial Benefit","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Skill Development Financial Benefit"));

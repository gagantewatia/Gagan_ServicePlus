...
public class DeathFinancialBenefitTestCase extends Base2
{
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				Assert.assertEquals(PQ.infoservicename2().getText(),"Death Financial Benefit","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Death Financial Benefit"));

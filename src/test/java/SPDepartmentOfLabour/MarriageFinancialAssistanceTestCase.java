...
public class MarriageFinancialAssistanceTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				Assert.assertEquals(PQ.infoservicename2().getText(),"Marriage Financial Assistance","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Marriage Financial Assistance"));

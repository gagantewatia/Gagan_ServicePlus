	...
	//go to department page	
		...
		
		{
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Directorate of Education");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Directorate of Education :  " + cl.duplicateTestCases());
		     }
		}
...

		{
			test.assignCategory(DirectorateofEducation);
			commonlocators cl=new commonlocators(Driver);
		String x="Directorate of Education";

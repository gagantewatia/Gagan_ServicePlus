...
public class ReimbursementofSchoolStationaryKitsSchoolStationaryKitsTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoSchoolStationaryKits().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Reimbursement of School Stationary Kits","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Reimbursement of School Stationary Kits"));

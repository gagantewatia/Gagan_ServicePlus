...
public class HostelReimbursementofcashinlieuofMessbillStipendTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoHostelReimbursement().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Hostel Reimbursement of cash in lieu of Mess bill/Stipend","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Hostel Reimbursement of cash in lieu of Mess bill/Stipend"));

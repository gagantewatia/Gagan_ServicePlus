...
public class ReimbursementofcashinlieuofschooluniformSchoolUniformTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoSchoolUniform().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Reimbursement of cash in lieu of school uniform","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Reimbursement of cash in lieu of school uniform"));

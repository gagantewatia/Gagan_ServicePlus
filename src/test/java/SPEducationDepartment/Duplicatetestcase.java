	...
	//go to department page	
		...
		
		{
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Education Department");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Education Department :  " + cl.duplicateTestCases());
		     }
		}
...

		{
			...
			commonlocators cl=new commonlocators(Driver);
		String x="Education Department (School)";

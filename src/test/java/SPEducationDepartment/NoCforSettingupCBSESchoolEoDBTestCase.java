...
public class NoCforSettingupCBSESchoolEoDBTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoCBSESchool().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"NoC for Setting up CBSE School - EoDB","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("NoC for Setting up CBSE School - EoDB"));

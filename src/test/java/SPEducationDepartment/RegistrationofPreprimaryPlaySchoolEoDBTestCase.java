...
public class RegistrationofPreprimaryPlaySchoolEoDBTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoPlaySchool().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Registration of Pre-primary / Play School - EoDB","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Registration of Pre-primary / Play School - EoDB"));

...
public class RegistrationofElementarySchoolsunderRighttoEducationEoDBTestCase extends Base2
{
	...
	{
		test.assignCategory(EducationDepartment);
...
//go to department page	
...

	{
		test.assignCategory(EducationDepartment);
		 departmentnavigationpage SD=new departmentnavigationpage(Driver);
		 String Servicename="Education Department (School) Tripura";
	 	 SD.servicenavigationclick(Servicename);
		 Assert.assertEquals(SD.EducationDepartment().getText(),"Education Department (School) Tripura","Not matched");
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				EducationDepartment dp=new EducationDepartment(Driver); 
				dp.infoElementarySchools().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Registration of Elementary Schools under Right to Education-EoDB","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Registration of Elementary Schools under Right to Education-EoDB"));

...
public class FINANCIALAIDTONONSCHOOLGOINGDISABLEDCHILDRENUPTO18YEARSTestCase extends Base2
{
...
//go to department page	
	...
	Assert.assertTrue(s.contains("FINANCIAL AID TO NON SCHOOL GOING DISABLED CHILDREN UPTO 18 YEARS"));

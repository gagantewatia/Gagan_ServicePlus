	...
	//go to department page	
		...
		
		{
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Social Justice & Empowerment");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Social Justice & Empowerment :  " + cl.duplicateTestCases());
		     }
		}

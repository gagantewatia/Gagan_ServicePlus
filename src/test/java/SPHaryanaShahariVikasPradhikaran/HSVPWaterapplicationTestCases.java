...
public class HSVPWaterapplicationTestCases extends Base2
{
...
//go to department page	
...

	{
			...
			dp.infoWaterapplication().click();
			test.log(Status.INFO,"Clicked on i icon");
			Assert.assertEquals(PQ.infoservicename2().getText(),"HSVP Water application","Not matched");
			PQ.desccheck();
...
@Test(priority=6,dependsOnMethods = {"DeptNavigation"})
	...
	Assert.assertTrue(s.contains("HSVP Water application"));

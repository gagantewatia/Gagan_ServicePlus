...
public class HSVPNoDuesCertificateTestCases extends Base2
{
...
//go to department page	
	...
	//go to service and check heading
...

		{
				...
				Assert.assertEquals(PQ.infoservicename2().getText(),"HSVP - No Dues Certificate","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("HSVP - No Dues Certificate"));

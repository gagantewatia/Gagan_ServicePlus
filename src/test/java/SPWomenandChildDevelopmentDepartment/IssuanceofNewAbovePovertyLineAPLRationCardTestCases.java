package SPWomenandChildDevelopmentDepartment;
...
import Pageobject.SPWomenandChildDevelopmentDepartment.WomenandChildDevelopmentDepartment;
import Resources.Base2;

public class IssuanceofNewAbovePovertyLineAPLRationCardTestCases extends Base2
{
	...
	{
		test.assignCategory(WomenandChildDevelopmentDepartment);
...
//go to department page	
...

	{
		test.assignCategory(WomenandChildDevelopmentDepartment);
		 departmentnavigationpage SD=new departmentnavigationpage(Driver);
		 String Servicename="Women and Child Development Department";
	 	 SD.servicenavigationclick(Servicename);
		 Assert.assertEquals(SD.WomenandChildDevelopmentDepartment().getText(),"Women and Child Development Department","Not matched");
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				WomenandChildDevelopmentDepartment dp=new WomenandChildDevelopmentDepartment(Driver);
				dp.infoSahayataYojana().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename().getText(),"Mukhya Mantri Matritva Sahayata Yojana","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Mukhya Mantri Matritva Sahayata Yojana"));

	...
	//go to department page	
		...
		
		{
			...
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in WomenandChildDevelopmentDepartment.");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in WomenandChildDevelopmentDepartment: " + cl.duplicateTestCases());
		     }
...

		{
			test.assignCategory(WomenandChildDevelopmentDepartment);
			commonlocators cl=new commonlocators(Driver);
		String x="Women and Child Development Department";

	...
	public class Duplicatetestcase extends Base2
	{
		...
		
		{
			...
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Tourism Meghalaya");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Tourism Meghalaya " + cl.duplicateTestCases());
		     }
		}

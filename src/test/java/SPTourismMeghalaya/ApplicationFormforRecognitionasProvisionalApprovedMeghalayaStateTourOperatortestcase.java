...
import java.util.HashSet;
	...
	public class ApplicationFormforRecognitionasProvisionalApprovedMeghalayaStateTourOperatortestcase extends Base2
	{
		...
		{
			test.assignCategory(TourismMeghalaya);
	...
	//go to department page	
		...
		public void DeptNavigation() throws IOException, InterruptedException
		{
			test.assignCategory(TourismMeghalaya);
			 departmentnavigationpage SD=new departmentnavigationpage(Driver);
			 String Servicename="Tourism Meghalaya";
		 	 SD.servicenavigationclick(Servicename);
			 Assert.assertEquals(SD.TourismMeghalaya().getText(), "Tourism Meghalaya","Not matched");
	...
	Assert.assertTrue(s.contains("Application Form for Recognition as Provisional/ Approved Meghalaya State Tour Operator"));

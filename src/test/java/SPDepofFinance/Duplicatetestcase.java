	   ...
	   //Check service count present in dept 
		...
		
		{
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Department Of Finance");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Department Of Finance :  " + cl.duplicateTestCases());
		     }
		}
		...
		//check servcie count
				...
				{
					commonlocators cl=new commonlocators(Driver);
				String x="Department Of Finance Tripura";

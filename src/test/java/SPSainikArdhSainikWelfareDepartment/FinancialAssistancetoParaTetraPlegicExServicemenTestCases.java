...
public class FinancialAssistancetoParaTetraPlegicExServicemenTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				Assert.assertEquals(PQ.infoservicename2().getText(),"Financial Assistance to The Ex Servicemen For Marriage Grant","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Financial Assistance to The Ex Servicemen For Marriage Grant"));

...
public class DisabledExGratiaGrantofParaMilitaryForcesAccordingtothepercentageofDisabilityTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoParaMilitary().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Disabled Ex Gratia Grant of Para Military Forces According to the percentage of Disability","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Disabled Ex Gratia Grant of Para Military Forces According to the percentage of Disability"));

...
public class FinancialAssistanceofOrphanChildrenofExServicemenTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				Assert.assertEquals(PQ.infoservicename2().getText(),"Financial Assistance of Orphan Children of Ex Servicemen","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Financial Assistance of Orphan Children of Ex Servicemen"));

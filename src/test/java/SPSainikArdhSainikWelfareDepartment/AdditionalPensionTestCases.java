...
public class AdditionalPensionTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoAdditional().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Additional Pension","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Additional Pension"));

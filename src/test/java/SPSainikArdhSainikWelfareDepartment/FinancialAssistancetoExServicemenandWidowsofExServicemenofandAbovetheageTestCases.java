...
public class FinancialAssistancetoExServicemenandWidowsofExServicemenofandAbovetheageTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoWidowExServicemen().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Financial Assistance to Ex Servicemen and Widows of Ex Servicemen of and Above the age of 60","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Financial Assistance to Ex Servicemen and Widows of Ex Servicemen of and Above the age of 60"));

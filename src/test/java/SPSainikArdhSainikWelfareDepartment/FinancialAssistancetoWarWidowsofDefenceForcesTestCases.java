...
public class FinancialAssistancetoWarWidowsofDefenceForcesTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoWidowsDefenceForces().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Financial Assistance to War Widows of Defence Forces","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Financial Assistance to War Widows of Defence Forces"));

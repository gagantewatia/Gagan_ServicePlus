...
public class FinancialAssistancetoDisabledExServicemanTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				Assert.assertEquals(PQ.infoservicename2().getText(),"Financial Assistance to Disabled Ex Serviceman","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Financial Assistance to Disabled Ex Serviceman"));

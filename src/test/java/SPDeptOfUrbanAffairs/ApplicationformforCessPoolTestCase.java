...
public class ApplicationformforCessPoolTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoCessPool().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Application form for Cess Pool","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Application form for Cess Pool"));

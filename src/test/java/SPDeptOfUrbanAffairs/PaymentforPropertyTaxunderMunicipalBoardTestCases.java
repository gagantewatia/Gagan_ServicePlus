...
import Pageobject.SPDepOfUrbanAffairs.DepOfUrbanAffairs;
import Resources.Base2;

public class PaymentforPropertyTaxunderMunicipalBoardTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				DepOfUrbanAffairs dp=new DepOfUrbanAffairs(Driver);
				dp.infoPropertyTax().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Payment for Property Tax under Municipal Board","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Payment for Property Tax under Municipal Board"));

	...
	//go to department page	
		...
		
		{
			...
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Labour Department Meghalya");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Labour Department Meghalya " + cl.duplicateTestCases());
		     }
		}
		...
		{
			commonlocators cl=new commonlocators(Driver);
		String x="Labour Department Meghalya";

...
import java.util.HashSet;
	...
	public class LicenseforContractorsundertheContractLabourAct1970testcase extends Base2
	{
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoLabourAct().click();
				test.log(Status.INFO,"Clicked on i icon"); 
				Assert.assertEquals(PQ.infoservicename2().getText(),"License for Contractors under the Contract Labour Act 1970","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("License for Contractors under the Contract Labour Act 1970"));

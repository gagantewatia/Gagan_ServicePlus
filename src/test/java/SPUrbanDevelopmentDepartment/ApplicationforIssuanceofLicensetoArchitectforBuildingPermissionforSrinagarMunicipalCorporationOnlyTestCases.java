...
public class ApplicationforIssuanceofLicensetoArchitectforBuildingPermissionforSrinagarMunicipalCorporationOnlyTestCases extends Base2
{
...
//go to department page	
	...
	dp.ArchitectSrinagarMunicipalCorporation().click();
	Thread.sleep(2000);

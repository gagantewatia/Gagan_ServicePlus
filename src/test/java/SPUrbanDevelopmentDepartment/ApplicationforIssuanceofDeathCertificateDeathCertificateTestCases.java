...
public class ApplicationforIssuanceofDeathCertificateDeathCertificateTestCases extends Base2
{
...
//go to department page	
	...
	
	{
		...
		Assert.assertTrue(s.contains("Application for Issuance of Death Certificate"));

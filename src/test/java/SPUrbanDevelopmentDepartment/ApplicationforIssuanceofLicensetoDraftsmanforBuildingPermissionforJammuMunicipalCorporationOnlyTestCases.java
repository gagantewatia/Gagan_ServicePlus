...
public class ApplicationforIssuanceofLicensetoDraftsmanforBuildingPermissionforJammuMunicipalCorporationOnlyTestCases extends Base2
{
...
//go to department page	
	...
	dp.DraftsmanJammuMunicipalCorporation().click();
	Thread.sleep(2000);

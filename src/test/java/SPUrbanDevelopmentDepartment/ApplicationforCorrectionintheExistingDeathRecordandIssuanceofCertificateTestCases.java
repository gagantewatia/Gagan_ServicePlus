...
public class ApplicationforCorrectionintheExistingDeathRecordandIssuanceofCertificateTestCases extends Base2
{
...
//go to department page	
	...
	
	{
			...
			Assert.assertTrue(s.contains("Application for Correction in the Existing Death Record and Issuance of Certificate"));

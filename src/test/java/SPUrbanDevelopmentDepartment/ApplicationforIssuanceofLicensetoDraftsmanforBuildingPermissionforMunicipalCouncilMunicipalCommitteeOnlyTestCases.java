...
public class ApplicationforIssuanceofLicensetoDraftsmanforBuildingPermissionforMunicipalCouncilMunicipalCommitteeOnlyTestCases extends Base2
{
...
//go to department page	
	...
	dp.DraftsmanMunicipalCouncilMunicipalCommittee().click();
	Thread.sleep(2000);
	...
	
	{
		...
		Assert.assertTrue(s.contains("Application for Issuance of License to Draftsman for Building Permission for Municipal Council / Municipal Committee Only"));

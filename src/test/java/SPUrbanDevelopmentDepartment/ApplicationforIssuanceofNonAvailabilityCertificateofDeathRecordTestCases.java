...
public class ApplicationforIssuanceofNonAvailabilityCertificateofDeathRecordTestCases extends Base2
{
...
//go to department page	
	...
	
	{
		...
		Assert.assertTrue(s.contains("Application for Issuance of Non-Availability Certificate of Death Record"));

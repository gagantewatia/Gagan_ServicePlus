...
public class ApplicationforIssuanceofLicensetoArchitectforBuildingPermissionforMunicipalCouncilMunicipalCommitteeOnlyTestCases extends Base2
{
...
//go to department page	
	...
	dp.ArchitectMunicipalCouncilMunicipalCommittee().click();
	Thread.sleep(2000);
	...
	
	{
		...
		Assert.assertTrue(s.contains("Application for Issuance of License to Architect for Building Permission for Municipal Council / Municipal Committee Only"));

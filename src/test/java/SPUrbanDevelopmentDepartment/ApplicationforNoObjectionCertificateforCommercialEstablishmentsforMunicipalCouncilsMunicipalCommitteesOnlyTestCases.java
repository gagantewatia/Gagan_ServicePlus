...
public class ApplicationforNoObjectionCertificateforCommercialEstablishmentsforMunicipalCouncilsMunicipalCommitteesOnlyTestCases extends Base2
{
...
//go to department page	
	...
	dp.CommercialEstablishments().click();
	Thread.sleep(2000);

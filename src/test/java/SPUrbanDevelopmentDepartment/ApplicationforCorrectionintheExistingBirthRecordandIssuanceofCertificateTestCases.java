...
public class ApplicationforCorrectionintheExistingBirthRecordandIssuanceofCertificateTestCases extends Base2
{
...
//go to department page	
	...
	public void DeptNavigation() throws IOException, InterruptedException
	{
		test.assignCategory(UrbanDevelopmentDepartment);
		 ...
		 Assert.assertEquals(SD.UrbanDevelopmentDepartment().getText(),"Urban Development Department","Not matched");
	...
	
	{
		...
		Assert.assertTrue(s.contains("Application for Correction in the Existing Birth Record and Issuance of Certificate"));

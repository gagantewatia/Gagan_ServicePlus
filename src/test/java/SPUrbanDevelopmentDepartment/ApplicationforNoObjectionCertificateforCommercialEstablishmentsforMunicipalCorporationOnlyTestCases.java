...
public class ApplicationforNoObjectionCertificateforCommercialEstablishmentsforMunicipalCorporationOnlyTestCases extends Base2
{
...
//go to department page	
	...
	
	{
		...
		Assert.assertTrue(s.contains("Application for No Objection Certificate for Commercial Establishments for Municipal Corporation Only"));

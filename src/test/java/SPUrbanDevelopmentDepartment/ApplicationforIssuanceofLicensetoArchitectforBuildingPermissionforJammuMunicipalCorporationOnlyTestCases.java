...
public class ApplicationforIssuanceofLicensetoArchitectforBuildingPermissionforJammuMunicipalCorporationOnlyTestCases extends Base2
{
...
//go to department page	
	...
	dp.ArchitectJammuMunicipalCorporation().click();
	Thread.sleep(2000);

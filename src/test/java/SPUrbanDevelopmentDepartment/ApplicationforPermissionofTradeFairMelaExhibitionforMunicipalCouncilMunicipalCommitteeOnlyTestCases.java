...
public class ApplicationforPermissionofTradeFairMelaExhibitionforMunicipalCouncilMunicipalCommitteeOnlyTestCases extends Base2
{
...
//go to department page	
	...
	
	{
		...
		Assert.assertTrue(s.contains("Application for Permission of Trade Fair / Mela / Exhibition for Municipal Council / Municipal Committee Only"));

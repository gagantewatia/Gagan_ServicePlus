...
public class ApplicationforSewerageConnectionforMunicipalCouncilMunicipalCommitteeOnlySewerageMunicipalCouncilTestCases extends Base2
{
...
//go to department page	
	...
	dp.SewerageMunicipalCouncil().click();
	Thread.sleep(2000);

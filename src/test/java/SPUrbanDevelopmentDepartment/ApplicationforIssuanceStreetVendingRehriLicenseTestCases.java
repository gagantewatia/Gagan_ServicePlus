...
public class ApplicationforIssuanceStreetVendingRehriLicenseTestCases extends Base2
{
	//go to all services
	@Test(priority=1)
...
//go to department page	
	...
	
	{
		...
		Assert.assertTrue(s.contains("Application for Issuance Street Vending / Rehri License"));

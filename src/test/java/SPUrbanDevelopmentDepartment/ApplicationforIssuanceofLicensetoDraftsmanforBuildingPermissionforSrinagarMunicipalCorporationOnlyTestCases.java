...
public class ApplicationforIssuanceofLicensetoDraftsmanforBuildingPermissionforSrinagarMunicipalCorporationOnlyTestCases extends Base2
{
...
//go to department page	
	...
	dp.DraftsmanSrinagarMunicipalCorporation().click();
	Thread.sleep(2000);

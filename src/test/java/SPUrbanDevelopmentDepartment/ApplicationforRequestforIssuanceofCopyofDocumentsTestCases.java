...
public class ApplicationforRequestforIssuanceofCopyofDocumentsTestCases extends Base2
{
...
//go to department page	
	...
	
	{
		...
		Assert.assertTrue(s.contains("Application for Request for Issuance of Copy of Documents"));

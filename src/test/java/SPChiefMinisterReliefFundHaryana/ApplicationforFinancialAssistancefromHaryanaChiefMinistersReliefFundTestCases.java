package SPChiefMinisterReliefFundHaryana;
...
import Pageobject.SPChiefMinisterReliefFundHaryana.ChiefMinisterReliefFundHaryana;
import Resources.Base2;

public class ApplicationforFinancialAssistancefromHaryanaChiefMinistersReliefFundTestCases extends Base2
{
...
//go to department page	
...

	{
		test.assignCategory(ChiefMinisterReliefFund);
		 departmentnavigationpage SD=new departmentnavigationpage(Driver);
		 String Servicename="Chief Minister Relief Fund Haryana";
	 	 SD.servicenavigationclick(Servicename);
		 Assert.assertEquals(SD.ChiefMinisterReliefFund().getText(),"Chief Minister Relief Fund Haryana","Not matched");
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				PQ.seeinfo1iconflat().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename().getText(),"Application for Financial Assistance from Haryana Chief Ministers Relief Fund/ हरियाणा मुख्यमंत्री राहत कोष से आर्थिक सहायता के","Not matched");
				PQ.desccheck();
	...
	{
	test.assignCategory(ChiefMinisterReliefFund);
	ChiefMinisterReliefFundHaryana dp=new ChiefMinisterReliefFundHaryana(Driver);
	//click on the service 
	dp.ChiefMinisters().click();
	Thread.sleep(2000);
	List<String> browserTabs = new ArrayList<String> (Driver.getWindowHandles());
	//switch to new tab
	...
	Assert.assertTrue(s.contains("Application for Financial Assistance from Haryana Chief Ministers Relief Fund/ हरियाणा मुख्यमंत्री राहत कोष से आर्थिक सहायता के"));

...
public class HighYieldingTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				Assert.assertEquals(PQ.infoservicename().getText(),"Assistance to farmers under High Yielding Programme","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Assistance to farmers under High Yielding Programme"));

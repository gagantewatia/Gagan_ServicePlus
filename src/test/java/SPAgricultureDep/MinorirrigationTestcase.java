...
public class MinorirrigationTestcase extends Base2
{
...
//go to department page	
	...
	public void Deptnavigation() throws IOException, InterruptedException
	{
		...
		public void Seeinfoclick() throws IOException, InterruptedException

			{
					...
					dp.infoMinorIrrigation().click();
					test.log(Status.INFO,"Clicked on i icon"); 
					Assert.assertEquals(PQ.infoservicename2().getText(),"Development of Minor Irrigation","Not matched");
					PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Development of Minor Irrigation"));

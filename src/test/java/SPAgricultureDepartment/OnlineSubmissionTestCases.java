package SPAgricultureDepartment;
...
//go to department page	
...

	{
		test.assignCategory(AgricultureDepartment);
		 departmentnavigationpage SD=new departmentnavigationpage(Driver);
		 String Servicename="Agriculture Department Meghalaya";
	 	 SD.servicenavigationclick(Servicename);
		 Assert.assertEquals(SD.AgricultureDep().getText(),"Agriculture Department Meghalaya","Not matched");
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoOnlineSubmission().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Online submission of Aadhaar Card to the District Agriculture Office for PM Kisan Beneficiary ONLY","Not matched");
				PQ.desccheck();

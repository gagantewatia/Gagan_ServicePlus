package SPHaryanaVeterinaryCouncil;
...
import Pageobject.SPHaryanaVeterinaryCouncil.HaryanaVeterinaryCouncil;
import Resources.Base2;

public class ApplicationforNewRegistrationofVeterinaryPractitionerTestCases extends Base2
{
	...
	{
		test.assignCategory(HaryanaVeterinaryCouncil);
...
//go to department page	
...

	{
		test.assignCategory(HaryanaVeterinaryCouncil);
		 departmentnavigationpage SD=new departmentnavigationpage(Driver);
		 String Servicename="Haryana Veterinary Council";
	 	 SD.servicenavigationclick(Servicename);
		 Assert.assertEquals(SD.HaryanaVeterinaryCouncil().getText(),"Haryana Veterinary Council","Not matched");
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				HaryanaVeterinaryCouncil dp=new HaryanaVeterinaryCouncil(Driver);
				dp.infoVeterinary().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Application for New Registration of Veterinary Practitioner","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Application for New Registration of Veterinary Practitioner"));

	...
	//go to department page	
		...
		
		{
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Health and Family Welfare");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Health and Family Welfare :  " + cl.duplicateTestCases());
		     }
		}
		...
		public void servicecountfromexcel() throws IOException, InterruptedException
				{
					commonlocators cl=new commonlocators(Driver);
				String x="Health and Family Welfare";

...
public class DistanceCertificateTestCases extends Base2
{
...
//go to department page	
	...
	//go to department page	
		...
		//go to service and check heading
...

				{
						...
						dp.infoDistance().click();
						test.log(Status.INFO,"Clicked on i icon");
						Assert.assertEquals(PQ.infoservicename2().getText(),"Distance Certificate","Not matched");
						PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Distance Certificate"));

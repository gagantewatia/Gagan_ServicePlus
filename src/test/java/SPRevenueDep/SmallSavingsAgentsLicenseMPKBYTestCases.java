...
public class SmallSavingsAgentsLicenseMPKBYTestCases extends Base2
{
	...
	//go to department page	
		...
		//go to service and check heading
...

				{
						...
						dp.infoSmallSavings().click();
						test.log(Status.INFO,"Clicked on i icon");
						Assert.assertEquals(PQ.infoservicename2().getText(),"Small Savings Agents License MPKBY","Not matched");
						PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Small Savings Agents License MPKBY"));

...
public class RenewalofSmallSavingsAgentLicenseMPKBYTestCases extends Base2
{
	...
	//go to department page	
		...
		//go to service and check heading
...

				{
						...
						Assert.assertEquals(PQ.infoservicename2().getText(),"Renewal of Small Savings Agent License (MPKBY)","Not matched");
						PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Renewal of Small Savings Agent License (MPKBY)"));

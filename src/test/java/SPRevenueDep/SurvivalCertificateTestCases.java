...
public class SurvivalCertificateTestCases extends Base2
{
	...
	//go to department page	
		...
		//go to service and check heading
...

				{
						...
						dp.infoSurvival().click();
						test.log(Status.INFO,"Clicked on i icon");
						Assert.assertEquals(PQ.infoservicename2().getText(),"Survival Certificate","Not matched");
						PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Survival Certificate"));

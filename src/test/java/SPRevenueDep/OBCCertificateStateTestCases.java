...
public class OBCCertificateStateTestCases extends Base2
{
	...
	//go to department page	
		...
		//go to service and check heading
...

				{
						...
						Assert.assertEquals(PQ.infoservicename2().getText(),"OBC Certificate – State","Not matched");
						PQ.desccheck();
	...
	Assert.assertTrue(s.contains("OBC Certificate – State"));

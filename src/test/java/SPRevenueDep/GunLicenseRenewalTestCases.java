...
public class GunLicenseRenewalTestCases extends Base2
{
...
//go to department page	
	...
	//go to service and check heading
...

			{
					...
					Assert.assertEquals(PQ.infoservicename2().getText(),"Gun License Renewal","Not matched");
					PQ.desccheck();
	...
	test.assignCategory(RevenueDep);
	RevenueDep dp=new RevenueDep(Driver);
	String s = dp.PHGun().getText();
	Assert.assertTrue(s.contains("Gun License Renewal - Application Form"));

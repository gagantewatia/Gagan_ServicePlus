...
public class PermanentResidentofTripuraCertificateTestCases extends Base2
{
	...
	//go to department page	
		...
		//go to service and check heading
...

				{
						...
						dp.infoPermanent().click();
						test.log(Status.INFO,"Clicked on i icon");
						Assert.assertEquals(PQ.infoservicename2().getText(),"Permanent Resident of Tripura Certificate","Not matched");
						PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Permanent Resident of Tripura Certificate"));

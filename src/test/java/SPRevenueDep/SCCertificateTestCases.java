...
public class SCCertificateTestCases extends Base2
{
...
//go to department page	
	//go to department page	
		...
		//go to service and check heading
...

				{
						...
						Assert.assertEquals(PQ.infoservicename2().getText(),"SC Certificate","Not matched");
						PQ.desccheck();
	...
	Assert.assertTrue(s.contains("SC Certificate"));

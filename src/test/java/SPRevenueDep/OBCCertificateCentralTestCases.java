...
public class OBCCertificateCentralTestCases extends Base2
{
	...
	//go to department page	
		...
		//go to service and check heading
...

				{
						...
						dp.infoCentral().click();
						test.log(Status.INFO,"Clicked on i icon");
						Assert.assertEquals(PQ.infoservicename2().getText(),"OBC Certificate – Central","Not matched");
						PQ.desccheck();
	...
	Assert.assertTrue(s.contains("OBC Certificate – Central"));

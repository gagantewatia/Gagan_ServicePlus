...
public class STCertificateTestCases extends Base2
{
...
//go to department page	
	...
	//go to department page	
		...
		//go to service and check heading
...

				{
						...
						Assert.assertEquals(PQ.infoservicename2().getText(),"ST Certificate","Not matched");
						PQ.desccheck();
	...
	Assert.assertTrue(s.contains("ST Certificate"));

...
import Pageobject.SPPunjabEngineeringCollege.PunjabEngineeringCollege;
import Resources.Base2;

public class UTChandigarhInstituteFellowshipSchemeforPhDTestCases extends Base2
{
...
//go to department page	
	...
	//go to service and check heading
...

		{
				...
				PunjabEngineeringCollege dp=new PunjabEngineeringCollege(Driver); 
				dp.infoChandigarhInstitute().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"UT Chandigarh Institute Fellowship Scheme for PhD","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("UT Chandigarh Institute Fellowship Scheme for PhD"));

...
import java.util.HashSet;
	...
	public class LodgeComplaintforWaterSeweronShikayatNivaranKendraofPublicHealthEngineeringDepartmenttestcase extends Base2
	{
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoShikayatNivaran().click();
				test.log(Status.INFO,"Clicked on i icon"); 
				Assert.assertEquals(PQ.infoservicename2().getText(),"Lodge Complaint for Water/Sewer on Shikayat Nivaran Kendra of Public Health Engineering Department(PHED)","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Lodge Complaint for Water/Sewer on Shikayat Nivaran Kendra of Public Health Engineering Department(PHED)"));

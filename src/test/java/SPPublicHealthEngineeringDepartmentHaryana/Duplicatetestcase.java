	...
	//go to department page	
		...
		
		{
			...
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Public Health Engineering Department");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Public Health Engineering Department " + cl.duplicateTestCases());
		     }
		}
		...
		{
			commonlocators cl=new commonlocators(Driver);
		String x="Public Health Engineering Department";

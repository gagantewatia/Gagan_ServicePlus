	...
	//go to department page	
		...
		
		{
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Directorate of Industries");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Directorate of Industries :  " + cl.duplicateTestCases());
		     }
		}
...

		{
			test.assignCategory(DirectorateOfIndustries);
			commonlocators cl=new commonlocators(Driver);
		String x="Directorate of Industries";

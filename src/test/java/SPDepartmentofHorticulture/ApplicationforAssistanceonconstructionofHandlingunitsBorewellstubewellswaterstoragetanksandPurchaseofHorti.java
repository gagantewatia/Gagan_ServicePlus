...
public class ApplicationforAssistanceonconstructionofHandlingunitsBorewellstubewellswaterstoragetanksandPurchaseofHorti extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoPurchaseofHorti().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Application for Assistance on construction of Handling units, Bore wells, tube wells, water storage tanks, and Purchase of Horti","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Application for Assistance on construction of Handling units, Bore wells, tube wells, water storage tanks, and Purchase of Horticulture Machinery"));

...
public class Bookingfordevelopmentofhighdensityorchard extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infohighdensityorchard().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Booking for development of high density orchard","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Booking for development of high density orchard"));

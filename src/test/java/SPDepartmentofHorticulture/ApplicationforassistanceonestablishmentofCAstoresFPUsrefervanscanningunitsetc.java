...
public class ApplicationforassistanceonestablishmentofCAstoresFPUsrefervanscanningunitsetc extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infocanningunits().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Application for assistance on establishment of CA stores FPUs refer vans canning units etc","Not matched");
				PQ.desccheck();

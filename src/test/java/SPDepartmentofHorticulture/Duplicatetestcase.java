	...
	//go to department page	
		...
		
		{
			...
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Department of Horticulture");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Department of Horticulture " + cl.duplicateTestCases());
		     }
		}
...

		{
			test.assignCategory(DepartmentofHorticulture);
			commonlocators cl=new commonlocators(Driver);
		String x="Department of Horticulture";

	...
	//go to department page	
		...
		
		{
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Employment Department");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Employment Department :  " + cl.duplicateTestCases());
		     }
		}
...

		{
			test.assignCategory(EmploymentDepartment);
			commonlocators cl=new commonlocators(Driver);
		String x="Employment Department";

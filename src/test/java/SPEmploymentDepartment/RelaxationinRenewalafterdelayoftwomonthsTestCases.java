...
public class RelaxationinRenewalafterdelayoftwomonthsTestCases extends Base2
{
   //go to all services
	@Test(priority=1)
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infotwomonths().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Relaxation in Renewal after delay of two months","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Relaxation in Renewal after delay of two months"));

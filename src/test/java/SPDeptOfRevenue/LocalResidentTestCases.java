...
public class LocalResidentTestCases extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoLocalResident().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Issue of Local Resident Certificate","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Issue of Local Resident Certificate"));

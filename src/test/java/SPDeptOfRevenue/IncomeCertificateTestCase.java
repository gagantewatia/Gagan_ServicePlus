...
public class IncomeCertificateTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoIncomeCertificate().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Issue of Income Certificate","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Issue of Income Certificate"));

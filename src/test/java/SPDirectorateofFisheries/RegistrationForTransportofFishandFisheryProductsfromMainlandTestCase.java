...
public class RegistrationForTransportofFishandFisheryProductsfromMainlandTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoProductsfromMainland().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Registration For Transport of Fish and Fishery Products from Mainland","Not matched");
				PQ.desccheck();
	...
	test.assignCategory(DirectorateofFisheries);
	DirectorateOfFisheries dp=new DirectorateOfFisheries(Driver);
	String s = dp.HeadingProductsfromMainland().getText();
	Assert.assertTrue(s.contains("Directorate of Fisheries"));

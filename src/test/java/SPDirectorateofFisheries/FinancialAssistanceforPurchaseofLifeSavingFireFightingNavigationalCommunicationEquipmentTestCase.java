...
public class FinancialAssistanceforPurchaseofLifeSavingFireFightingNavigationalCommunicationEquipmentTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoFinancialAssistance().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Financial Assistance for Purchase of Life Saving, Fire Fighting, Navigational ,Communication Equipment","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Financial Assistance for Purchase of Life Saving, Fire Fighting, Navigational ,Communication Equipment"));

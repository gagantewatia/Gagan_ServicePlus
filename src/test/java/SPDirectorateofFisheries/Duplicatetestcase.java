	...
	//go to department page	
		...
		
		{
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Directorate of Fisheries");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Directorate of Fisheries :  " + cl.duplicateTestCases());
		     }
		}
...

		{
			test.assignCategory(DirectorateofFisheries);
			commonlocators cl=new commonlocators(Driver);
		String x="Directorate of Fisheries";

...
public class RegistrationforTransportofFishandFisheryProductsfromIslandsTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoProductsfromIslands().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Registration for Transport of Fish and Fishery Products from Islands","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Registration for Transport of Fish and Fishery Products from Islands"));

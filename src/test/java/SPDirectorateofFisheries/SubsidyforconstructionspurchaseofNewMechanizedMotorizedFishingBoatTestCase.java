...
public class SubsidyforconstructionspurchaseofNewMechanizedMotorizedFishingBoatTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoFishingBoat().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Subsidy for constructions/purchase of New Mechanized / Motorized Fishing Boat","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Subsidy for constructions/purchase of New Mechanized / Motorized Fishing Boat"));

	...
	//go to department page	
		...
		
		{
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Directorate of Health Services");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Directorate of Health Services :  " + cl.duplicateTestCases());
		     }
		}
...

		{
			test.assignCategory(DirectorateOfHealthServices);
			commonlocators cl=new commonlocators(Driver);
		String x="Directorate of Health Services";

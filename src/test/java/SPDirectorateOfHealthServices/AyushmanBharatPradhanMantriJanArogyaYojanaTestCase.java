...
public class AyushmanBharatPradhanMantriJanArogyaYojanaTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoAyushmanBharat().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Ayushman Bharat Pradhan Mantri Jan Arogya Yojana","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Ayushman Bharat Pradhan Mantri Jan Arogya Yojana"));

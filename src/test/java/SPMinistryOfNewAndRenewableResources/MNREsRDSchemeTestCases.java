package SPMinistryOfNewAndRenewableResources;
...
public class MNREsRDSchemeTestCases extends Base2
{
	...
	{
		test.assignCategory(MinistryOfNewAndRenewableResources);
...
//go to department page	
...

	{
		test.assignCategory(MinistryOfNewAndRenewableResources);
		 departmentnavigationpage SD=new departmentnavigationpage(Driver);
		 String Servicename="Ministry of New and Renewable Resources";
	 	 SD.servicenavigationclick(Servicename);
		 Assert.assertEquals(SD.MinistryOfNewAndRenewableResources().getText(),"Ministry of New and Renewable Resources","Not matched");
	...
	//go to service and check heading
...

		{
				...
				MinistryOfNewAndRenewableResources dp=new MinistryOfNewAndRenewableResources(Driver); 
				dp.infoScheme().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"MNRE's R&D Scheme","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("MNRE's R&D Scheme"));

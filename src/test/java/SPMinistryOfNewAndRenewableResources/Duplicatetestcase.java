	...
	//go to department page	
		...
		
		{
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Ministry of New and Renewable Resources");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Ministry of New and Renewable Resources :  " + cl.duplicateTestCases());
		     }
		}
...

		{
			test.assignCategory(MinistryOfNewAndRenewableResources);
			commonlocators cl=new commonlocators(Driver);
		String x="Ministry of New and Renewable Resources";

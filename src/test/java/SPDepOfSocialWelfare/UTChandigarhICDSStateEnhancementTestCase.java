...
public class UTChandigarhICDSStateEnhancementTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				Assert.assertEquals(PQ.infoservicename2().getText(),"UT Chandigarh ICDS State Enhancement","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("UT Chandigarh ICDS State Enhancement"));

...
public class PostNatalFinancialassistancebelongingtotheSCwomenTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoSCwomen().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Post Natal Financial assistance belonging to the SC women","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Post Natal Financial assistance belonging to the SC women"));

...
public class FinancialAssistancetoDependentChildrenofWidowsandDestituteWomenTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoChildrenofWidows().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Financial Assistance to Dependent Children of Widows and Destitute Women","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Financial Assistance to Dependent Children of Widows and Destitute Women"));

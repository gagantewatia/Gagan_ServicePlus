...
public class PetrolsubsidytophysicallyhandicappedpersonTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoPetrolsubsidy().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Petrol subsidy to physically handicapped person","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Petrol subsidy to physically handicapped person"));

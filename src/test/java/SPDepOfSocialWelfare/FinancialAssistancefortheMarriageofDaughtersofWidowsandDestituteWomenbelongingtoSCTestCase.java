...
public class FinancialAssistancefortheMarriageofDaughtersofWidowsandDestituteWomenbelongingtoSCTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoDaughtersofWidows().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Financial Assistance for the Marriage of Daughters of Widows and Destitute Women belonging to SC","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Financial Assistance for the Marriage of Daughters of Widows and Destitute Women belonging to SC"));

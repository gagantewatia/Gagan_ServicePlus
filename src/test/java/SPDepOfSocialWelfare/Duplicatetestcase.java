	...
	//go to department page	
		...
		
		{
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Department of Social Welfare, Women and Child Development, Chandigarh Administration");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Department of Social Welfare, Women and Child Development, Chandigarh Administration :  " + cl.duplicateTestCases());
		     }
		}
		...
		//check servcie count
				...
				{
					commonlocators cl=new commonlocators(Driver);
				String x="Department of Social Welfare, Women and Child Development, Chandigarh Administration";

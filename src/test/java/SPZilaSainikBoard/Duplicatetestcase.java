	...
	//go to department page	
		...
		
		{
			...
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Zila Sainik Board");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Zila Sainik Board :  " + cl.duplicateTestCases());
		     }
		}
...

		{
			test.assignCategory(ZilaSainikBoard);
			commonlocators cl=new commonlocators(Driver);
		String x="Zila Sainik Board Chandigarh";

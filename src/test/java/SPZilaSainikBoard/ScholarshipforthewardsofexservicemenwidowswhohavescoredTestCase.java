...
public class ScholarshipforthewardsofexservicemenwidowswhohavescoredTestCase extends Base2
{
...
//go to department page	
	...
	public void Seeinfoclick() throws IOException, InterruptedException

		{
				...
				dp.infoScholarship().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"Scholarship for the wards of ex-servicemen, widows who have scored 60% or above in class 10, 12","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Scholarship for the wards of ex-servicemen, widows who have scored 60% or above in class 10, 12"));

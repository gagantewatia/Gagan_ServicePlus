...
public class RenewalofFireSafetyCertificateTestCase extends Base2
{
...
//go to department page	
	...
	///go to service and check heading
...

			{
					...
					dp.infoSafetyCertificate().click();
					test.log(Status.INFO,"Clicked on i icon");
					Assert.assertEquals(PQ.infoservicename2().getText(),"Renewal of Fire Safety Certificate","Not matched");
					PQ.desccheck();
	...
	Assert.assertTrue(s.contains("Renewal of Fire Safety Certificate"));

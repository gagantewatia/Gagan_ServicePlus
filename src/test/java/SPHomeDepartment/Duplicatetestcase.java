	...
	//go to department page	
		...
		
		{
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Home Department (Fire Service)");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Home Department (Fire Service) :  " + cl.duplicateTestCases());
		     }
		}
...

		{
			test.assignCategory(HomeDepartment);
			commonlocators cl=new commonlocators(Driver);
		String x="Home Department (Fire Service)";

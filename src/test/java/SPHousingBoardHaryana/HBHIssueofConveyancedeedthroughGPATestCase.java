...
public class HBHIssueofConveyancedeedthroughGPATestCase extends Base2
{
	...
	//go to service and check heading
...

		{
				...
				Assert.assertEquals(PQ.infoservicename2().getText(),"HBH-Issue of Conveyance deed through GPA","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("HBH-Issue of Conveyance deed through GPA"));

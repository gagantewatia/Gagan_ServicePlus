...
public class HBHIssueofNoDuesCertificateTestCase extends Base2
{
...
//go to department page	
	...
	//go to service and check heading
...

		{
				...
				dp.infoDuesCertificate().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"HBH-Issue of No Dues Certificate","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("HBH-Issue of No Dues Certificate"));

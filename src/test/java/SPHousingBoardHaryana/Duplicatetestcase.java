	...
	//go to department page	
		...
		
		{
			commonlocators cl=new commonlocators(Driver);
		     ...
		     {
		         System.out.println("No duplicate names found in Housing Board Haryana");
		     } 
		     else 
		     {
		         System.out.println("Duplicate names found in Housing Board Haryana :  " + cl.duplicateTestCases());
		     }
		}
...

		{
			test.assignCategory(HousingBoardHaryana);
			commonlocators cl=new commonlocators(Driver);
		String x="Housing Board Haryana";

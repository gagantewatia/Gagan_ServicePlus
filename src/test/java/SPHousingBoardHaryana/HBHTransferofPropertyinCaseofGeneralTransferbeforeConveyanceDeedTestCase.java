...
public class HBHTransferofPropertyinCaseofGeneralTransferbeforeConveyanceDeedTestCase extends Base2
{
	...
	//go to service and check heading
...

		{
				...
				dp.infoGeneralTransfer().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"HBH-Transfer of Property in Case of General Transfer before Conveyance Deed","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("HBH-Transfer of Property in Case of General Transfer before Conveyance Deed"));

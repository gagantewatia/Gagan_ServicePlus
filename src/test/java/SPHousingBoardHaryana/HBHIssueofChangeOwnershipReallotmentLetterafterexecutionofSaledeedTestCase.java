...
public class HBHIssueofChangeOwnershipReallotmentLetterafterexecutionofSaledeedTestCase extends Base2
{
...
//go to department page	
	...
	//go to service and check heading
...

		{
				...
				dp.infoReallotmentLetter().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"HBH-Issue of Change Ownership/Re-allotment Letter after execution of Sale deed","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("HBH-Issue of Change Ownership/Re-allotment Letter after execution of Sale deed"));

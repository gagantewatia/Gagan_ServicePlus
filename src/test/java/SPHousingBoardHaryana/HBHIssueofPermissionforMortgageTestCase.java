...
public class HBHIssueofPermissionforMortgageTestCase extends Base2
{
	...
	//go to service and check heading
...

		{
				...
				dp.infoMortgage().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"HBH-Issue of Permission for Mortgage","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("HBH-Issue of Permission for Mortgage"));

...
public class HBHTransferofPropertyincaseofSaledeedTestCase extends Base2
{
...
//go to department page	
	...
	//go to service and check heading
...

		{
				...
				dp.infoSaledeed().click();
				test.log(Status.INFO,"Clicked on i icon");
				Assert.assertEquals(PQ.infoservicename2().getText(),"HBH-Transfer of Property in case of Sale deed","Not matched");
				PQ.desccheck();
	...
	Assert.assertTrue(s.contains("HBH-Transfer of Property in case of Sale deed"));
